    ...
    public function storeClaims(Request $request)
    {
        try {
            ...
            return response()->json([
                'status' => true,
                'status_code' => 200,
                'message' => __('messages.api.claims_added_successfully'),
                'data' => $claim,
            ]);
        } catch (\Exception $e) {
            return response()->json([
    ...
    public function updateClaims(Request $request)
    {
        try {
            ...
            return response()->json([
                'status' => true,
                'status_code' => 200,
                'message' => __('messages.api.claims_updated_successfully'),
                'data' => $claim,
            ]);
        } catch (\Exception $e) {
            return response()->json([
        ...
        try {
            ...
            if (($key = array_search($documentPath, $attachments)) !== false) {
                ...
                return response()->json([
                    'status' => true,
                    'status_code' => 200,
                    'message' => __('messages.api.document_removed_successfully'),
                    'data' => $claim,
                ]);
            } else {
                ...
                return response()->json([
                    'status' => false,
                    'status_code' => 404,
                    'message' => __('messages.api.document_not_found_in_claim'),
                    'data' => []
                ]);
            }
        } catch (\Exception $e) {
    ...
    public function claimsList(Request $request)
    {
        try {
            ...
            return response()->json([
                'status' => true,
                'status_code' => 200,
                'message' => __('messages.api.claims_retrieved_successfully'),
                'data' => $claims,
            ]);
        } catch (\Exception $e) {
            return response()->json([
    ...
    public function sendClaimMessage(Request $request)
    {
        try {
            ...
            return response()->json([
                'status' => true,
                'status_code' => 200,
                'message' => __('messages.api.claims_message_sent_successfully'),
                'data' => $claims,
            ]);
        } catch (\Exception $e) {
            return response()->json([
    ...
    public function claimsChatsList(Request $request)
    {
        try {
            ...
            return response()->json([
                'status' => true,
                'status_code' => 200,
                'message' => __('messages.api.claims_messages_retrieved_successfully'),
                'data' => $data,
            ]);
        } catch (\Exception $e) {
            return response()->json([
