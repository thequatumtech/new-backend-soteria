...
class TravelPlanController extends Controller
{
    ...
    public function add_travel_plan(Request $request)
    {
        ...
        return view('admin.plan.travel-plans.add_travel_plan',compact('insurance_companies','line_of_businesses','countries','cities','districts','ages','geographical_areas'));
    }
    ...
    public function edit_travel_plan(Request $request, $id)
    {
        ...
        return view('admin.plan.travel-plans.edit_travel_plan',compact('insurance_companies','line_of_businesses','countries','cities','districts','ages','geographical_areas','plan'));
    }
    ...
    public function save_travel_plan(Request $request)
    {
        if($request->form_type == 'add'){
            ...
            foreach ($request->surcharge_band as $single) {
                ...
                $travel_insurance_plan_surcharge_band->min_age = trim($age_band[0]);
                $travel_insurance_plan_surcharge_band->max_age = trim($age_band[1]);
