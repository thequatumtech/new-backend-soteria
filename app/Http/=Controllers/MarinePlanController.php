...
class MarinePlanController extends Controller
{
    ...
    public function edit_marine_plan(Request $request, $id)
    {
        ...
        $categories = InsuredItemCategory::all();
        $sub_categories = InsuredItemSubCategory::all();
        return view('admin.plan.marine-plans.edit_marine_plan',compact('insurance_companies','line_of_businesses','countries','cities','districts','ages','plan','type_of_covers','categories','sub_categories'));
    }
