...
class InsuredItemCategoryController extends Controller
{
    ...
    {
        $request->validate([
            'name' => 'required|string|max:100|unique:insured_item_categories',
        ]);
    ...
    public function update(Request $request)
    {
        $request->validate([
            ...
            'name' => 'required|string|max:100|unique:insured_item_categories,name,'.$request->insured_item_category_id,
        ]);
