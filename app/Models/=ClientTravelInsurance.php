...
class ClientTravelInsurance extends Model
{
    ...
    {
        $plan = ClientTravelInsurance::select(
            'client_travel_insurances.*',
            'travel_plans.plan_name',
            'travel_plans.insurance_policy_text',
            'travel_plans.net_premium',
            'travel_plans.limit',
            'travel_plans.fees',
            'travel_plans.stamps',
