...
--}}
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                ...
                                <select name="restricted_country_ids[]" id="restricted_country_ids" class="form-select rounded-0 flex-grow-1 border-0 shadow1 select2" style="height: 3.5rem;" multiple required>
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                ...
                                <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                    <input type="text" name="limit" maxlength="10" style="border: none;" class="positive_number_only_2_decimal" required value="{{old('limit')?:($plan->limit ?? '')}}">
                                </div>
                            </div>
                        </div>
