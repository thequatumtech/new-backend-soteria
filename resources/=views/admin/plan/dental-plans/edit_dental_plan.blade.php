...
{{--                                <input type="text" style="border: none;" disabled value="{{$plan->insurance_company->company_name}}">--}}
                        ...
                        <table class="table-bordered" style="width: 100%;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                        <input type="text" name="net_premium" id="net_premium" class="calc_gross_premium positive_number_only_2_decimal" style="border: none;" value="{{old('net_premium',($plan->net_premium ?? ''))}}" required>
                                    </div>
                                </td>
                                <td>
                                    <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
