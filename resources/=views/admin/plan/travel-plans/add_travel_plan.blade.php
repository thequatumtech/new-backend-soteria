...
{{--                                <th>{{__('messages.plans.commission_amount')}}</th>--}}
                            ...
                            <tbody>
                            <tr>
                                <input type="hidden" id="net_premium1" style="border: none;" readonly>
                                {{-- <input type="hidden" name="commission_amount" id="commission_amount" style="border: none;" value="0" readonly> --}}
