                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                ...
                                <select name="medical_network_ids[]" class="form-select rounded-0 flex-grow-1 border-0 shadow1 select2" style="height: 3.5rem;" multiple>
                                    @foreach($medical_networks as $single)
                                        <option value="{{$single->id}}"
                                            {{ in_array($single->id, old('medical_network_ids', !empty($plan->medical_network_ids) ? json_decode($plan->medical_network_ids) : [])) ? 'selected' : '' }}>
                                            {{$single->name}}
                                        </option>
                                    @endforeach
                                </select>
