...
--}}
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                ...
                                <select name="restricted_dangerous_activities_ids[]" class="form-select rounded-0 flex-grow-1 border-0 shadow1 select2" style="height: 3.5rem;" multiple required>
...
{{--                                <th>{{__('messages.plans.gross_premium')}}</th>--}}
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                        <input type="text" id="calc_limit" style="border: none;" readonly>
                                    </div>
                                </td>
                                <input type="hidden" name="net_premium" id="net_premium" class="calc_gross_premium" style="border: none;">
{{--
                                <td>
                                    <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
...
--}}
                                ...
                                <input type="hidden" name="gross_premium" id="gross_premium" style="border: none;">
{{--
                                <td>
                                    <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
