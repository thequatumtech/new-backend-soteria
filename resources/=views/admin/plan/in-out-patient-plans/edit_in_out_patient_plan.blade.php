...
{{--                                <th>{{__('messages.plans.gross_premium')}}</th>--}}
                            ...
                            <tr>
                                ...
                                <input type="hidden" name="net_premium" id="net_premium" class="calc_gross_premium" style="border: none;" value="{{old('net_premium',($plan->net_premium ?? ''))}}" required>
{{--
                                <td>
                                    <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
...
--}}
                                ...
                                <input type="hidden" name="gross_premium" id="gross_premium" style="border: none;" value="{{old('gross_premium',($plan->gross_premium ?? ''))}}" readonly required>
{{--
                                <td>
                                    <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
