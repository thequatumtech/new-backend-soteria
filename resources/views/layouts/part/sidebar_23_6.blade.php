    ...
    <div class="sidebar-content">
        ...
        <div class="sidebar-menu">
            <ul>
                ...
                @if($is_super_admin == 1 || in_array('reports',$authorized_routes))
                ...
                <li class="sidebar-dropdown {{in_array($currentRouteName, ['ages.list','chronic_disease.list','claim_status.list','complaint_status.list','dangerous_activities.list','engine_capacity.list','engine_type.list','insurance_period.list','medical_network.list','motor_plan.list','protection_system.list','in_patient_deductible.list','out_patient_deductible.list','no_of_visits.list','country.list','district.list','occupations.list','language.list','nationality.list','currency.list','geographical_area.list','claim_deductible.list','cities.list','pages.vehicle-brand','pages.vehicle-categories','pages.vehicle-color','pages.vehicle-type','type_of_covers.list','insured-items-categories.list','insured_item_sub_categories.list']) ? 'active-main active' : '' }} ">
                    ...
                    <div class="sidebar-submenu" style="{{in_array($currentRouteName, ['ages.list','chronic_disease.list','claim_status.list','complaint_status.list','dangerous_activities.list','engine_capacity.list','engine_type.list','insurance_period.list','medical_network.list','motor_plan.list','protection_system.list','in_patient_deductible.list','out_patient_deductible.list','no_of_visits.list','country.list','district.list','occupations.list','language.list','nationality.list','currency.list','geographical_area.list','claim_deductible.list','cities.list','pages.vehicle-brand','pages.vehicle-categories','pages.vehicle-color','pages.vehicle-type','type_of_covers.list','insured-items-categories.list','insured_item_sub_categories.list']) ? 'display:block;' : '' }}">
                        <ul>
                            ...
                            <li class="inner-dropdown {{ in_array($currentRouteName, ['engine_capacity.list', 'engine_type.list', 'motor_plan.list','pages.vehicle-categories','pages.vehicle-brand','pages.vehicle-color','pages.vehicle-type']) ? 'active-main active' : '' }}">
                                <a href="javascript:void(0)">Motor <i class="fa fa-angle-right toggle-arrow" style="float:right;"></i></a>
                                    <ul class="inner-submenu" style="display: none;">
                                        <li class="{{ in_array($currentRouteName, ['engine_capacity.list']) ? 'active-main' : '' }}">
                                            <a href="{{ route('engine_capacity.list') }}">{{ __('messages.sidebar_titles.engine_capacity') }}</a>
                                        </li>
                                        ...
                                        <li class="{{ in_array($currentRouteName, ['motor_plan.list']) ? 'active-main' : '' }}">
                                          ...
                                          <li class="{{in_array($currentRouteName,['pages.vehicle-brand']) ? 'active-main' : ''}}">
                                            <a href="{{ route('pages.vehicle-brand') }}">{{__('messages.sidebar_titles.vehicle_brand')}}</a>
                                        </li>
                                        <li class="{{in_array($currentRouteName,['pages.vehicle-categories']) ? 'active-main' : ''}}">
                                            <a href="{{ route('pages.vehicle-categories') }}">{{__('messages.sidebar_titles.vehicle_category')}}</a>
                                        </li>
                                        <li class="{{in_array($currentRouteName,['pages.vehicle-color']) ? 'active-main' : ''}}">
                                            <a href="{{ route('pages.vehicle-color') }}">{{__('messages.sidebar_titles.vehicle_color')}}</a>
                                        </li>
                                        <li class="{{in_array($currentRouteName,['pages.vehicle-type']) ? 'active-main' : ''}}">
                                            <a href="{{ route('pages.vehicle-type') }}">{{__('messages.sidebar_titles.vehicle_type')}}</a>
                                        </li>
                                    </ul>
                            </li>
                               <li class="inner-dropdown {{ in_array($currentRouteName, ['insurance_period.list']) ? 'active-main active' : '' }}"">
                                <a href="javascript:void(0)">Personal <i class="fa fa-angle-right toggle-arrow" style="float:right;"></i></a>
                                    <ul class="inner-submenu" style="display: none;">
                                ...
                                <li class="inner-dropdown {{ in_array($currentRouteName, ['medical_network.list']) ? 'active-main active' : '' }}"">
                                    <a href="javascript:void(0)">Medical <i class="fa fa-angle-right toggle-arrow" style="float:right;"></i></a>
                                    <ul class="inner-submenu" style="display: none;">
                             ...
                             <li class="inner-dropdown {{ in_array($currentRouteName, ['protection_system.list']) ? 'active-main active' : '' }}"">
                                    <a href="javascript:void(0)">Home & Office <i class="fa fa-angle-right toggle-arrow" style="float:right;"></i></a>
                                    <ul class="inner-submenu" style="display: none;">
                                 ...
                                 <li class="inner-dropdown {{ in_array($currentRouteName, ['geographical_area.list']) ? 'active-main active' : '' }}"">
                                    <a href="javascript:void(0)">Travel <i class="fa fa-angle-right toggle-arrow" style="float:right;"></i></a>
                                    <ul class="inner-submenu" style="display: none;">
                                ...
                                <li class="inner-dropdown {{ in_array($currentRouteName, ['type_of_covers.list','insured-items-categories.list','insured_item_sub_categories.list']) ? 'active-main active' : '' }}"">
                                    <a href="javascript:void(0)">Marine <i class="fa fa-angle-right toggle-arrow" style="float:right;"></i></a>
                                    <ul class="inner-submenu" style="display: none;">
                            ...
                            <li class="{{in_array($currentRouteName,['in_patient_deductible.list']) ? 'active-main' : ''}}">
                                <a href="{{ route('in_patient_deductible.list') }}">{{__('messages.sidebar_titles.in_patient_deductible')}}</a>
                            </li>
                            <li class="{{in_array($currentRouteName,['out_patient_deductible.list']) ? 'active-main' : ''}}">
                                <a href="{{ route('out_patient_deductible.list') }}">{{__('messages.sidebar_titles.out_patient_deductible')}}</a>
                            </li>
                            <li class="{{in_array($currentRouteName,['no_of_visits.list']) ? 'active-main' : ''}}">
                                <a href="{{ route('no_of_visits.list') }}">{{__('messages.sidebar_titles.no_of_visits')}}</a>
                            </li>
                            <li class="{{in_array($currentRouteName,['claim_deductible.list']) ? 'active-main' : ''}}">
