    ...
    $claimDeductibleIds = old('claim_deductible_ids', json_decode($plan->claim_deductible_ids ?? '[]')) ?? [];
        ...
        $no_claim_discount = $matchingCondition ? $matchingCondition->discount : 0;
                            ...
                            <table class="table-bordered dynamic-table" style="width: 100%;">
                                ...
                                <tbody>
                                    @if (old('compulsory_schedule_3_months'))
                                    @foreach(old('compulsory_schedule_3_months') as $index => $item)
                                    <tr data-id="{{ $index }}">
                                        <td width="40%">
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                <input type="text" name="compulsory_schedule_3_months[{{ $index }}][vehicle_type]" value="{{ old('compulsory_schedule_3_months.' . $index . '.vehicle_type') }}" style="border: none;" required>
                                            </div>
                                        </td>
                                        <td width="40%">
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                <input type="text" name="compulsory_schedule_3_months[{{ $index }}][premium]" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" value="{{ old('compulsory_schedule_3_months.' . $index . '.premium') }}" style="border: none;" required>
                                            </div>
                                        </td>
                                        <td width="5%">
                                            <button class="btn p-0 m-0 deletebtn" title="Delete"><img src="{{asset('img/icon-delete.png')}}" alt=""></button>
                                        ...
                                        @if ($loop->first)
                                        <td rowspan="{{count(old('compulsory_schedule_3_months', []))}}" class="add-more-cell">
                                            <button class="btn add_more_btn" title="Add More">Add More</button>
                                        </td>
                                        @endif
                                    </tr>
                                    @endforeach
                                    @elseif(isset($compulsory_premiums) && $compulsory_premiums->count() > 0)
                                    @foreach($compulsory_premiums as $index => $item)
                                    <tr data-id="{{ $index }}">
                                        <td width="40%">
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                <input type="text" name="compulsory_schedule_3_months[{{ $index }}][vehicle_type]" value="{{ $item->vehicle_type ?? '' }}" style="border: none;" required>
                                            </div>
                                        </td>
                                        <td width="40%">
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                <input type="text" name="compulsory_schedule_3_months[{{ $index }}][premium]" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" value="{{ $item->premium ?? '' }}" style="border: none;" required>
                                            </div>
                                        </td>
                                        <td width="5%">
                                            <button class="btn p-0 m-0 deletebtn" title="Delete"><img src="{{asset('img/icon-delete.png')}}" alt=""></button>
                                        ...
                                        @if ($loop->first)
                                        <td rowspan="{{ $compulsory_premiums->count() }}" class="add-more-cell">
                                            <button class="btn add_more_btn" title="Add More">Add More</button>
                                        </td>
                                        @endif
                                    </tr>
                    ...
                    <table class="table-bordered" style="width: 100%;">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                        <input type="text" name="net_premium" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" style="border: none;" value="{{old('fees', $plan->fees->net_premium)}}" required>
                                    </div>
                                </td>
                                <td>
                                    <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                        <input type="text" name="commission_percentage" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" id="commission_percentage" style="border: none;" value="{{old('fees', $plan->fees->commission_percentage)}}" required>
                                    </div>
                                </td>
                                <td>
                                    <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                        <input type="text" name="commission_amount" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" style="border: none;" value="{{old('fees', $plan->fees->commission_amount)}}" required>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
