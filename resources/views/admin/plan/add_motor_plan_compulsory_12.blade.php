...
@section('content')
    <main class="flex-grow-1 pt-5">
        ...
        $increaseInNetPremium = $matchingCondition ? $matchingCondition->increase_in_net_premium : null;
                                                @endphp
        ...
        $current_year_increase = $matchingCondition ? $matchingCondition->current_year_increase : null;
        $first_year_increase = $matchingCondition ? $matchingCondition->first_year_increase : null;
        $second_year_increase = $matchingCondition ? $matchingCondition->second_year_increase : null;
        $third_year_increase = $matchingCondition ? $matchingCondition->third_year_increase : null;
        $fourth_year_increase = $matchingCondition ? $matchingCondition->fourth_year_increase : null;
        $fifth_year_increase = $matchingCondition ? $matchingCondition->fifth_year_increase : null;
                                        @endphp
        ...
        $no_claim_discount = $matchingCondition ? $matchingCondition->discount : null;
                                        @endphp
                            ...
                            <table class="table-bordered dynamic-table" style="width: 100%;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                <input type="text" name="additional_benefits[0][benefit_deductible]" required>
                                            </div>
                                        </td>
                                        <td width="5%">
                                            <button class="btn p-0 m-0 deletebtn" title="Delete"><img src="{{asset('img/icon-delete.png')}}" alt=""></button>
                            ...
                            <table class="table-bordered dynamic-table" style="width: 100%;">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td width="40%">
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                <input type="text" name="compulsory_schedule_12_months[0][premium]" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" style="border: none;" required>
                                            </div>
                                        </td>
                                        <td width="5%">
                                            <button class="btn p-0 m-0 deletebtn" title="Delete"><img src="{{asset('img/icon-delete.png')}}" alt=""></button>
                            ...
                            <table class="table-bordered" style="width: 100%;">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                <input type="text" name="fees" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" style="border: none;" value="{{ old('fees', isset($plan) ? $plan->fees->fees : '') }}" required>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                <input type="text" name="stamps" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" style="border: none;" value="{{old('stamps', isset($plan) ? $plan->fees->stamps : '')}}" required>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                <input type="text" name="sales_tax" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" style="border: none;" value="{{old('sales_tax', isset($plan) ? $plan->fees->sales_tax : '')}}" required>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                            ...
                            <table class="table-bordered" style="width: 100%;">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                <input type="text" name="net_premium" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" style="border: none;" value="{{old('fees', isset($plan) ? $plan->fees->net_premium : '')}}" required>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                <input type="text" name="commission_percentage" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" id="commission_percentage" style="border: none;" value="{{old('fees', isset($plan) ? $plan->fees->commission_percentage : '')}}" required>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                <input type="text" name="commission_amount" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" style="border: none;" value="{{old('fees', isset($plan) ? $plan->fees->commission_amount : '')}}" required>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
