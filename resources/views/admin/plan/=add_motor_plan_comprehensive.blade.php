    ...
    <div class="container-fluid">
        <div class="header d-flex justify-content-between p-3 py-2 align-items-center">
            <div class="text-white group-title fw-bold">
                ...
                @else
                {{__('messages.plans.add_comprehensive_plan')}}
                    @endif
            </div>
        </div>
...
--}}
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                ...
                                <select name="claim_deductible_ids[]" class="form-select rounded-0 flex-grow-1 border-0 shadow1 select2" style="height: 3.5rem;" multiple>
                                ...
                                <td>
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <input type="text" name="comprehensive_schedule[0][from]" class="border" required> 
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <label for="to">To</label>
                                                <div class="shadow1 p-2 mb-3" style="padding-bottom: 2.5rem;">
                                                <input type="text" name="comprehensive_schedule[0][to]" class="border" style="border: none;" required> 
                                                </div>
                                            </div>
                                        </div>
                                        {{-- <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                ...
                <table class="dynamic-table comprehensive" style="width: 100%;">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td width="30%">
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="shadow1 p-2 mb-3" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="commission_schedule[0][from]" class="form-control border-0" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <label for="to" class="form-label">To</label>
                                        <div class="shadow1 p-2 mb-3" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="commission_schedule[0][to]" class="form-control border-0" required>
                                        </div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td width="30%">
                                <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                    <input type="text" name="commission_schedule[0][commission]" class="form-control border-0" required>
                                </div>
                            </td>
                        ...
                        <table class="table-bordered" style="width: 100%;">
                            ...
                            {{-- <tr>
                                <td>
                                    <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                        <input type="text" name="fees" style="border: none;" required>
                                    </div>
                                </td>
                                <td>
                                    <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                        <input type="text" name="stamps" style="border: none;" required>
                                    </div>
                                </td>
                                <td>
                                    <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                        <input type="text" name="sales_tax" style="border: none;" required>
                                    </div>
                                </td>
                            </tr> --}}
                               <tr>
