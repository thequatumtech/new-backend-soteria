...
<main class="flex-grow-1 pt-5">
    <div class="container-fluid">
        ...
        <form action="{{route('travel_plan.save')}}" id="add_motor_plan" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                ...
                                <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                    <input type="number" id="policy_period" class="form-control number"
                                        name="policy_period" style="border: none;" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" required max="4745" value="{{$plan->policy_period}}">
                                </div>
                            </div>
                        </div>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                    <input type="text"
                                        name="plan_pricing[0][price]"
                                        class=""
                                        style="border: none;"
                                        required
                                        value="{{ data_get($plan, 'pricing_schedule.0.price', '') }}">
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                    <input type="text"
                                        name="plan_pricing[1][price]"
                                        class=""
                                        style="border: none;"
                                        required
                                        value="{{ data_get($plan, 'pricing_schedule.1.price', '') }}">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                    <input type="text"
                                        name="plan_pricing[2][price]"
                                        class=""
                                        style="border: none;"
                                        required
                                        value="{{ data_get($plan, 'pricing_schedule.2.price', '') }}">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                    <input type="text"
                                        name="plan_pricing[3][price]"
                                        class=""
                                        style="border: none;"
                                        required
                                        value="{{ data_get($plan, 'pricing_schedule.3.price', '') }}">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                    <input type="text"
                                        name="plan_pricing[4][price]"
                                        class=""
                                        style="border: none;"
                                        required
                                        value="{{ data_get($plan, 'pricing_schedule.4.price', '') }}">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                    <input type="text"
                                        name="plan_pricing[5][price]"
                                        class=""
                                        style="border: none;"
                                        required
                                        value="{{ data_get($plan, 'pricing_schedule.5.price', '') }}">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                    <input type="text"
                                        name="plan_pricing[6][price]"
                                        class=""
                                        style="border: none;"
                                        required
                                        value="{{ data_get($plan, 'pricing_schedule.6.price', '') }}">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                    <input type="text"
                                        name="plan_pricing[7][price]"
                                        class=""
                                        style="border: none;"
                                        required
                                        value="{{ data_get($plan, 'pricing_schedule.7.price', '') }}">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                    <input type="text"
                                        name="plan_pricing[8][price]"
                                        class=""
                                        style="border: none;"
                                        required
                                        value="{{ data_get($plan, 'pricing_schedule.8.price', '') }}">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                    <input type="text"
                                        name="plan_pricing[9][price]"
                                        class=""
                                        style="border: none;"
                                        required
                                        value="{{ data_get($plan, 'pricing_schedule.9.price', '') }}">
                ...
                <table class="table-bordered dynamic-table" style="width: 100%;">
                    ...
                    <tbody>
                            ...
                            <td>
                                <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                    <input type="text" name="surcharge_band[{{ $index }}][age_band]"
                                        value="{{ old('surcharge_band.'.$index.'.age_band') }}" oninput="this.value = this.value.replace(/[^0-9-]/g, '').replace(/(.*?)-(.*?)-.*/, '$1-$2').replace(/^-/, '');"
                                        style="border: none;" required>
                                </div>
                            </td>
                            <td>
                                <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                    <input type="text" name="surcharge_band[{{ $index }}][surcharge]" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');"
                        ...
                        <tr>
                            <td>
                                <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                    <input type="text" name="surcharge_band[{{ $index }}][age_band]" oninput="this.value = this.value.replace(/[^0-9-]/g, '').replace(/(.*?)-(.*?)-.*/, '$1-$2').replace(/^-/, '');"
                ...
                <table class="table-bordered dynamic-table" style="width: 100%;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                    <input type="text" name="discount_band[{{ $index }}][age_band]" oninput="this.value = this.value.replace(/[^0-9-]/g, '').replace(/(.*?)-(.*?)-.*/, '$1-$2').replace(/^-/, '');"
                            ...
                            <td>
                                <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                    <input type="text" name="discount_band[{{ $index }}][discount]" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');"
            ...
            <td>
                <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                    <input type="text" name="cbj" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" style="border: none;" value="{{old('cbj',($plan->cbj ?? ''))}}" class="calc_gross_premium positive_number_only_2_decimal" id="cbj" required>
                </div>
            </td>
            <td>
                <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                    <input type="text" name="salextaxcbj" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" style="border: none;" value="{{old('salextaxcbj',($plan->sales_tax_cbj ?? ''))}}" class="calc_gross_premium positive_number_only_2_decimal" id="cbj_sales_tax" required>
                </div>
            </td>
            {{-- <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
    ...
    <table class="table-bordered" style="width: 100%;">
        ...
        <tbody>
            <tr>
                <input type="hidden" id="net_premium1" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" style="border: none;" value="{{old('net_premium',($plan->net_premium ?? ''))}}" readonly>
                <input type="hidden" name="commission_amount" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" id="commission_amount" style="border: none;" value="{{old('commission_amount',($plan->commission_amount ?? 0))}}" required readonly>
                {{--
                ...
                <td>
                    <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                        <input type="text" name="commission_percentage" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" id="commission_percentage" class="positive_number_only_2_decimal" style="border: none;" value="{{old('commission_percentage',($plan->commission_percentage ?? ''))}}" required>
                    </div>
                </td>
...
<!-- <script>
    $(document).ready(function() {
        ...
        function loadCountriesByGeoArea(geoAreaId, selectedIds) {
            var $countriesSelect = $('select[name="countries[]"]');
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (selectedIds && selectedIds.length > 0) {
                        $countriesSelect.val(selectedIds.map(String)).trigger('change');
                    } else {
        ...
        // On page load — pass saved country IDs for pre-selection
        var initialGeoAreaId = $('select[name="geographical_areas_ids"]').val();
        var savedCountryIds = @json($plan -> countries ?? []);

        if (initialGeoAreaId) {
            loadCountriesByGeoArea(initialGeoAreaId, savedCountryIds);
        }

        // On geo area change — reload countries, clear selection
        $('select[name="geographical_areas_ids"]').on('change', function() {
            loadCountriesByGeoArea($(this).val(), []);
        });
