                        ...
                        @foreach($plans as $key => $data)
                            ...
                            --}}
                              @if(canAccessRoute('insurance_plans_edit'))
                                <a href="{{route('travel_plan.edit', encrypt($data->id))}}" class="btn p-0 m-0" title="Edit">
        ...
        <div class="modal fade " id="DeleteModal" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-xl">
                <div class="modal-content">
                    ...
                    <form action="{{route('travel_plan.delete')}}" method="post">
...
@section('script')
    <script src="{{asset('js/travel_plan.js')}}"></script>
@endsection
