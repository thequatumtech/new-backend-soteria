                ...
                <div class="row p-3" style="color: #92959A;">
                    <div class="container">
                        ...
                        <table class="table-bordered dynamic-table" style="width: 100%;">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="plan_pricing[0][price]" class="positive_number_only_2_decimal" style="border: none;" required>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="plan_pricing[1][price]" class="positive_number_only_2_decimal" style="border: none;" required>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="plan_pricing[2][price]" class="positive_number_only_2_decimal" style="border: none;" required>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="plan_pricing[3][price]" class="positive_number_only_2_decimal" style="border: none;" required>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="plan_pricing[4][price]" class="positive_number_only_2_decimal" style="border: none;" required>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="plan_pricing[5][price]" class="positive_number_only_2_decimal" style="border: none;" required>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="plan_pricing[6][price]" class="positive_number_only_2_decimal" style="border: none;" required>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="plan_pricing[7][price]" class="positive_number_only_2_decimal" style="border: none;" required>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="plan_pricing[8][price]" class="positive_number_only_2_decimal" style="border: none;" required>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="plan_pricing[9][price]" class="positive_number_only_2_decimal" style="border: none;" required>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
                        ...
                        <table class="table-bordered" style="width: 100%;">
                            ...
                            <tbody>
                                <tr>
                                    {{-- <input type="hidden" id="net_premium1" style="border: none;" value="0" readonly> --}}
                                    {{-- <input type="text" name="commission_amount" id="commission_amount" style="border: none;" value="0" readonly> --}}
