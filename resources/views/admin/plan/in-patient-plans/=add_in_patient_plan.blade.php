                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                ...
                                // If no old input and $plan is set (edit mode), decode saved JSON
                        ...
                        <table class="table-bordered" style="width: 100%;">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" id="calc_limit" style="border: none;" class="positive_number_only_2_decimal">
                                        </div>
                                    </td>
                                    <!-- <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                        ...
                        <table class="table-bordered" style="width: 100%;">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="commission_percentage" id="commission_percentage" style="border: none;" class="positive_number_only_2_decimal" required>
                                        </div>
                                    </td>
                                    <!-- <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
