        ...
        <div class="container-fluid">
            <div class="header d-flex justify-content-between p-3 py-2 align-items-center">
                <div class="text-white group-title fw-bold">
                    ...
                    @else
                    {{__('messages.plans.add_in_patient_plan')}}
                    @endif
                </div>
            </div>
                                ...
                                <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                    ...
                                    <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                        <input type="number" id="policy_period" class="form-control number"
                                            name="policy_period" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" style="border: none;" required max="4745">
                                    </div>
                                </div>
                            </div>
                            ...
                            <table class="table-bordered" style="width: 100%;">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                <input type="text" id="calc_limit" style="border: none;" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" readonly class="positive_number_only_2_decimal">
                                            </div>
                                        </td>
                                        {{-- <td>
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                        ...
                                        <input type="hidden" name="gross_premium" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" id="gross_premium" style="border: none;">
                            ...
                            <table class="table-bordered" style="width: 100%;">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                <input type="text" name="commission_percentage" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" id="commission_percentage" style="border: none;" class="positive_number_only_2_decimal" required>
                                            </div>
                                        </td>
                                        {{-- <td>
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
