    ...
    <div class="container-fluid">
        <div class="header d-flex justify-content-between p-3 py-2 align-items-center">
            <div class="text-white group-title fw-bold">
                {{__('messages.plans.edit_in_patient_plan')}}
            </div>
        </div>
        <form action="{{route('in_patient_plan.save')}}" id="add_motor_plan" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="body bg-white py-4 px-4 d-flex flex-column gap-3 pb-5">
                    ...
                    <div class="container">
                            ...
                            <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                ...
                                <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                    <input type="number" id="policy_period" class="form-control number"
                                        name="policy_period" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" style="border: none;" required max="4745" value="{{$plan->policy_period}}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                ...
                                <select name="in_patient_deductibles_ids[]" class="form-select rounded-0 flex-grow-1 border-0 shadow1 select2" style="height: 3.5rem;" multiple>
                            ...
                            <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                ...
                                @php
                                // Get selected values from old input or the existing model
                                $selected_ids = old('medical_networks_ids');

                                if (!$selected_ids && isset($plan)) {
                                $selected_ids = json_decode($plan->medical_networks_ids, true) ?? [];
                                }
                                @endphp

                                <select name="medical_networks_ids[]" class="form-select rounded-0 flex-grow-1 border-0 shadow1 select2" style="height: 3.5rem;" multiple>
                                    @foreach($medical_networks as $single)
                                    <option value="{{ $single->id }}" {{ in_array($single->id, $selected_ids ?? []) ? 'selected' : '' }}>
                                        {{ $single->name }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <table class="table-bordered dynamic-table" style="width: 100%;">
                            ...
                            <tbody>
                                ...
                                <tr data-id="{{$index}}">
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="male_pricing_schedule[{{ $index }}][age_band]" oninput="this.value = this.value.replace(/[^0-9-]/g, '').replace(/(.*?)-(.*?)-.*/, '$1-$2').replace(/^-/, '');" value="{{ old('male_pricing_schedule.'.$index.'.age_band') }}" style="border: none;" required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                ...
                                <tr data-id="{{$index}}">
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="male_pricing_schedule[{{ $index }}][age_band]" oninput="this.value = this.value.replace(/[^0-9-]/g, '').replace(/(.*?)-(.*?)-.*/, '$1-$2').replace(/^-/, '');" value="{{ $single->lower_age . '-'. $single->upper_age}}" style="border: none;" required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                ...
                                <tr>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="male_pricing_schedule[0][age_band]" oninput="this.value = this.value.replace(/[^0-9-]/g, '').replace(/(.*?)-(.*?)-.*/, '$1-$2').replace(/^-/, '');" class="age_band" style="border: none;" required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                        ...
                        <table class="table-bordered dynamic-table" style="width: 100%;">
                            ...
                            <tbody>
                                ...
                                <tr data-id="{{$index}}">
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="female_pricing_schedule[{{ $index }}][age_band]" oninput="this.value = this.value.replace(/[^0-9-]/g, '').replace(/(.*?)-(.*?)-.*/, '$1-$2').replace(/^-/, '');" value="{{ old('female_pricing_schedule.'.$index.'.age_band') }}" style="border: none;" required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                ...
                                <tr data-id="{{$index}}">
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="female_pricing_schedule[{{ $index }}][age_band]" oninput="this.value = this.value.replace(/[^0-9-]/g, '').replace(/(.*?)-(.*?)-.*/, '$1-$2').replace(/^-/, '');" value="{{ $single->lower_age . '-'. $single->upper_age}}" style="border: none;" required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                ...
                                <tr>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="female_pricing_schedule[0][age_band]" oninput="this.value = this.value.replace(/[^0-9-]/g, '').replace(/(.*?)-(.*?)-.*/, '$1-$2').replace(/^-/, '');" class="age_band" style="border: none;" required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                        ...
                        <table class="table-bordered" style="width: 100%;">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" id="calc_limit" style="border: none;" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" value="{{old('limit',($plan->limit ?? ''))}}" readonly>
                                        </div>
                                    </td>

                                    {{-- <td>
                                    <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                        <input type="text" name="net_premium" id="net_premium" class="calc_gross_premium" style="border: none;" value="{{old('net_premium',($plan->net_premium ?? ''))}}" required>
                    </div>
                    </td> --}}
                    <input type="hidden" name="net_premium" id="net_premium" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" class="calc_gross_premium" style="border: none;">
                ...
                <input type="hidden" name="gross_premium" id="gross_premium" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" style="border: none;">
            ...
            <td>
                <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                    <input type="text" name="commission_percentage" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" id="commission_percentage" class="positive_number_only_2_decimal" style="border: none;" value="{{old('commission_percentage',($plan->commission_percentage ?? ''))}}" required>
                </div>
            </td>
            {{--
                                <td>
...
<script src="{{asset('js/in_patient_plan.js?v=2')}}"></script>
@endsection