    ...
    <div class="container-fluid">
        ...
        <form action="{{route('in_out_patient_plan.save')}}" id="add_motor_plan" method="post" enctype="multipart/form-data">
            ...
            <div class="body bg-white py-4 px-4 d-flex flex-column gap-3 pb-5">
                            ...
                            <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                ...
                                <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                    <input type="number" id="policy_period" class="form-control number"
                                        oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" name="policy_period" style="border: none;" required max="4745" value="{{$plan->policy_period}}">
                                </div>
                            </div>
                        </div>
                        ...
                        <table class="table-bordered dynamic-table" style="width: 100%;">
                            ...
                            <tbody>
                                ...
                                <tr data-id="0">
                                    ...
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="policy_covers[0][cover_limit]" value="{{ old('policy_covers.0.cover_limit') }}" style="border: none;" required>
                                        </div>
                                    </td>
                                    <td width="5%">
                                        <button class="btn p-0 m-0 deletebtn" title="Delete"><img src="{{asset('img/icon-delete.png')}}" alt=""></button>
                        ...
                        <table class="table-bordered dynamic-table" style="width: 100%;">
                            ...
                            <tbody>
                                ...
                                <tr data-id="{{$index}}">
                                    ...
                                    @if ($loop->first)
                                    <td rowspan="{{$plan->male_pricing_schedule->count()}}" class="add-more-cell">
                                        <button class="btn add_more_btn" title="Add More">Add More</button>
                                    </td>
                                    @endif
                                </tr>
                        ...
                        <table class="table-bordered dynamic-table" style="width: 100%;">
                            ...
                            <tbody>
                                ...
                                <tr data-id="{{$index}}">
                                    ...
                                    @if ($loop->first)
                                    <td rowspan="{{$plan->female_pricing_schedule->count()}}" class="add-more-cell">
                                        <button class="btn add_more_btn" title="Add More">Add More</button>
                                    </td>
                                    @endif
                                </tr>
                        ...
                        <table class="table-bordered" style="width: 100%;">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" id="calc_limit" style="border: none;" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" value="{{old('limit',($plan->limit ?? ''))}}" readonly>
                                        </div>
                                    </td>
                                    <!-- <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                ...
                <td>
                    <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                        <input type="text" name="commission_percentage" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" id="commission_percentage" style="border: none;" class="positive_number_only_2_decimal" value="{{old('commission_percentage',($plan->commission_percentage ?? ''))}}" required>
                    </div>
                </td>
                {{-- <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
