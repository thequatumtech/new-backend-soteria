    ...
    <div class="container-fluid">
        <div class="header d-flex justify-content-between p-3 py-2 align-items-center">
            <div class="text-white group-title fw-bold">
                ...
                @else
                {{__('messages.plans.add_in_out_patient_plan')}}
                @endif
            </div>
        </div>
                    ...
                    <div class="container">
                            ...
                            <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                ...
                                <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                    <input type="number" id="policy_period" class="form-control number"
                                        oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" name="policy_period" style="border: none;" required max="4745">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                ...
                                <select name="in_patient_deductibles_ids[]" class="form-select rounded-0 flex-grow-1 border-0 shadow1 select2" style="height: 3.5rem;" multiple>
                                    ...
                                    <option value="{{$single->id}}" {{in_array($single->id,old('in_patient_deductibles_ids',[]))}}>{{$single->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                <div>{{__('messages.plans.out_patient_deductible')}}</div>
                                <select name="out_patient_deductibles_ids[]" class="form-select rounded-0 flex-grow-1 border-0 shadow1 select2" style="height: 3.5rem;" multiple>
                                    @foreach($out_patient_deductibles as $single)
                                    <option value="{{$single->id}}" {{in_array($single->id,old('out_patient_deductibles_ids',[]))}}>{{$single->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                ...
                                <select name="no_of_visits_ids[]" class="form-select rounded-0 flex-grow-1 border-0 shadow1 select2" style="height: 3.5rem;" multiple>
                                    @foreach($no_of_visits as $single)
                                    <option value="{{$single->id}}" {{in_array($single->id,old('no_of_visits_ids',[]))}}>{{$single->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                ...
                                <select name="medical_networks_ids[]" class="form-select rounded-0 flex-grow-1 border-0 shadow1 select2" style="height: 3.5rem;" multiple>
                                    ...
                                    <option value="{{$single->id}}" {{in_array($single->id,old('medical_networks_ids',[]))}}>{{$single->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <table class="table-bordered" style="width: 100%;">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" id="calc_limit" oninput="this.value = this.value.replace(/[^0-9-]/g, '').replace(/(.*?)-(.*?)-.*/, '$1-$2').replace(/^-/, '');" style="border: none;" readonly>
                                        </div>
                                    </td>
                                    <input type="hidden" name="net_premium" id="net_premium" oninput="this.value = this.value.replace(/[^0-9-]/g, '').replace(/(.*?)-(.*?)-.*/, '$1-$2').replace(/^-/, '');" class="calc_gross_premium" style="border: none;">
                                    {{--
                                <td>
                                    <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
...
--}}
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="fees" id="fees" oninput="this.value = this.value.replace(/[^0-9-]/g, '').replace(/(.*?)-(.*?)-.*/, '$1-$2').replace(/^-/, '');" class="calc_gross_premium positive_number_only_2_decimal" style="border: none;" required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="stamps" id="stamps" oninput="this.value = this.value.replace(/[^0-9-]/g, '').replace(/(.*?)-(.*?)-.*/, '$1-$2').replace(/^-/, '');" class="calc_gross_premium positive_number_only_2_decimal" style="border: none;" required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="sales_tax" id="sales_tax" oninput="this.value = this.value.replace(/[^0-9-]/g, '').replace(/(.*?)-(.*?)-.*/, '$1-$2').replace(/^-/, '');" class="calc_gross_premium positive_number_only_2_decimal" style="border: none;" required>
                                        </div>
                                    </td>
                                    <input type="hidden" name="gross_premium" id="gross_premium" oninput="this.value = this.value.replace(/[^0-9-]/g, '').replace(/(.*?)-(.*?)-.*/, '$1-$2').replace(/^-/, '');" style="border: none;" readonly>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="cbj" style="border: none;" oninput="this.value = this.value.replace(/[^0-9-]/g, '').replace(/(.*?)-(.*?)-.*/, '$1-$2').replace(/^-/, '');" class="calc_gross_premium positive_number_only_2_decimal" id="cbj" required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="salextaxcbj" style="border: none;" oninput="this.value = this.value.replace(/[^0-9-]/g, '').replace(/(.*?)-(.*?)-.*/, '$1-$2').replace(/^-/, '');" class="calc_gross_premium positive_number_only_2_decimal" id="cbj_sales_tax" required>
                                        </div>
                                    </td>
                                    {{-- <td>
                                    <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
...
--}}
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="commission_percentage" oninput="this.value = this.value.replace(/[^0-9-]/g, '').replace(/(.*?)-(.*?)-.*/, '$1-$2').replace(/^-/, '');" id="commission_percentage" class="positive_number_only_2_decimal" style="border: none;" required>
                                        </div>
                                    </td>
                                    {{--
                                <td>
