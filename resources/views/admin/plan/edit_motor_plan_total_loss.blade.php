                ...
                <div class="row p-3" style="color: #92959A;">
                    <div class="container">
                        ...
                        <table class="table-bordered dynamic-table" style="width: 100%;">
                            ...
                            <tbody>
                                @forelse($total_loss_schedules as $index => $schedule)
                                <tr>
                                    <td width="20%">
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <select name="total_loss_schedule[{{$index}}][vehicle_brand_id]" class="form-select rounded-0 flex-grow-1 border-0 shadow1 select2 select2-custom" style="height: 3.5rem;" required>
                                                <option></option>
                                                @foreach($vehicle_brands as $single)
                                                <option value="{{$single->id}}" {{$single->id == $schedule->vehicle_brand_id ? 'selected' : ''}}>{{$single->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </td>
                                    <td width="20%">
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <select name="total_loss_schedule[{{$index}}][vehicle_category_id]" class="form-select rounded-0 flex-grow-1 border-0 shadow1 select2 select2-custom" style="height: 3.5rem;" required>
                                                <option></option>
                                                @foreach($vehicle_categories as $single)
                                                <option value="{{$single->id}}" {{$single->id == $schedule->vehicle_category_id ? 'selected' : ''}}>{{$single->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="total_loss_schedule[{{$index}}][insured_value]" value="{{$schedule->insured_value}}" style="border: none;" required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="total_loss_schedule[{{$index}}][premium]" value="{{$schedule->premium}}" style="border: none;" required>
                                        </div>
                                    </td>
                                    <td width="5%">
                                        <button class="btn p-0 m-0 deletebtn" title="Delete"><img src="{{asset('img/icon-delete.png')}}" alt=""></button>
                                ...
                                <tr>
                                    <td width="20%">
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <select name="total_loss_schedule[0][vehicle_brand_id]" class="form-select rounded-0 flex-grow-1 border-0 shadow1 select2 select2-custom" style="height: 3.5rem;" required>
                                                <option></option>
                                                @foreach($vehicle_brands as $single)
                                    ...
                                    <td width="20%">
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <select name="total_loss_schedule[0][vehicle_category_id]"
                                    ...
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="total_loss_schedule[0][insured_value]" style="border: none;" required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="total_loss_schedule[0][premium]" style="border: none;" required>
                                        </div>
                                    </td>
                                    <td width="5%">
                                        <button class="btn p-0 m-0 deletebtn" title="Delete"><img src="{{asset('img/icon-delete.png')}}" alt=""></button>
                        ...
                        <table class="table-bordered" style="width: 100%;">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="cbj" style="border: none;" value="{{old('cbj',($plan->fees->cbj ?? ''))}}" class="calc_gross_premium positive_number_only_2_decimal" id="cbj" required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="salextaxcbj" style="border: none;" value="{{old('salextaxcbj',($plan->fees->sales_tax_cbj ?? ''))}}" class="calc_gross_premium positive_number_only_2_decimal" id="cbj_sales_tax" required>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
                        ...
                        <table class="table-bordered" style="width: 100%;">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="commission_percentage" id="commission_percentage" style="border: none;" value="{{old('fees', $plan->fees->commission_percentage)}}" required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
