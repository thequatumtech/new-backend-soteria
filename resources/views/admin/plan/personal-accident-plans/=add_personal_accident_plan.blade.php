            ...
            <div class="body bg-white py-4 px-4 d-flex flex-column gap-3 pb-5">
                <div class="row p-3" style="color: #92959A;">
                        ...
                        <table class="table-bordered dynamic-table" style="width: 100%;">
                            ...
                            <tbody>
                                <tr data-id="0">
                                    ...
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="policy_covers[0][cover_premium]" style="border: none;" class="cover_premium" required>
                                        </div>
                                    </td>
                                    <td width="5%">
                    ...
                    @for ($i = 1; $i <= 60; $i++)
                        ...
                        <td>
                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                <input type="text" name="pricing_schedule[{{ $i }}][age]" style="border: none;" value="{{ $i  }}" readonly required>
                            </div>
                        </td>
                        <td class="selected-period-input">
                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                <input type="text" class="dynamic-input" name="pricing_schedule[{{ $i }}][m_1]" style="border: none;" required value="{{ old('pricing_schedule.' . $i . '.m_1', (isset($plan) && isset($plan->pricingSchedules) ? $plan->pricingSchedules->where('age', $i)->first()->m_1 ?? '' : '')) }}">
                            </div>
                        </td>
                        </tr>
                        @endfor
                        ...
                        <table class="table-bordered" style="width: 100%;">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    {{-- <input type="hidden" name="net_premium" id="net_premium" class="calc_gross_premium" style="border: none;" value="0"> --}}
                                    <!-- <td>
                                    <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                    ...
                                    {{-- <input type="hidden" name="gross_premium" id="gross_premium" style="border: none;" value="0"> --}}
                                    <!-- <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                        ...
                        <table class="table-bordered" style="width: 100%;">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <!-- <input type="hidden" name="commission_amount" id="commission_amount" style="border: none;" value="0">
