    ...
    <div class="container-fluid">
        <div class="header d-flex justify-content-between p-3 py-2 align-items-center">
            <div class="text-white group-title fw-bold">
                {{__('messages.plans.add_personal_accident_plan')}}
            </div>
        </div>
                            ...
                            <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                ...
                                <select name="insurance_period_id" class="form-select rounded-0 flex-grow-1 border-0 shadow1" style="height: 3.5rem;" required>
                                    ...
                                    <option value="{{ $single->id }}" data-name="{{ $single->name }}"
                                        {{ (old('insurance_period_id') && old('insurance_period_id') == $single->id) ? 'selected' : (isset($plan->insurance_period_id) && $plan->insurance_period_id == $single->id ? 'selected' : '') }}>
                                        {{ $single->name }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <table class="table-bordered dynamic-table" style="width: 100%;">
                            ...
                            <tbody>
                                <tr data-id="0">
                                    <td width="50%">
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="policy_covers[0][cover_name]" style="border: none;" required class="number">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                        ...
                        <table class="table-bordered" style="width: 100%;">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <input type="hidden" name="gross_premium" id="gross_premium" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" style="border: none;" value="0">
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                        ...
                        <table class="table-bordered" style="width: 100%;">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="commission_percentage" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" id="commission_percentage" class="positive_number_only_2_decimal" style="border: none;" required>
                                        </div>
                                    </td>
