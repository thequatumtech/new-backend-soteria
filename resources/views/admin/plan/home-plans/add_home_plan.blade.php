        ...
        <div class="container-fluid">
            <div class="header d-flex justify-content-between p-3 py-2 align-items-center">
                <div class="text-white group-title fw-bold">
                    ...
                    @else
                    {{__('messages.plans.add_home_plan')}}
                    @endif
                </div>
            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                    ...
                                    <select name="restricted_home_age_ids[]" class="form-select rounded-0 flex-grow-1 border-0 shadow1 select2" style="height: 3.5rem;" multiple>
                                        @foreach($ages as $single)
                                        <option value="{{$single->id}}" {{ in_array($single->id, old('restricted_home_age_ids', [])) ? 'selected' : '' }}>
                            ...
                            <table class="table-bordered" style="width: 100%;">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                <input type="text" id="calc_limit" style="border: none;" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" readonly class="positive_number_only_2_decimal">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                <input type="text" name="net_premium" id="net_premium" class="calc_gross_premium calnet positive_number_only_2_decimal" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" style="border: none;" readonly required>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                        ...
                                        <td>
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                <input type="text" name="salextaxcbj" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" style="border: none;" class="calc_gross_premium positive_number_only_2_decimal" id="cbj_sales_tax" required>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                <input type="text" name="gross_premium" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" id="gross_premium" style="border: none;" readonly required class="positive_number_only_2_decimal">
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
                            ...
                            <table class="table-bordered" style="width: 100%;">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                <input type="text" id="net_premium1" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" style="border: none;" class="calnet" readonly>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
            ...
            if (companyId) {
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#commission_percentage').val(response.commission_percentage ?? '').trigger('input'); // this will fire your existing handler
                    },
                    error: function() {
...
<script src="{{asset('js/home_plan.js?v=1.1')}}"></script>
@endsection
