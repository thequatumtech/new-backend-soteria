                ...
                <table id="example" class="table table-striped " style="width:100%">
                    ...
                    @foreach($plans as $key => $data)
                                                 ...
                                                 @if(canAccessRoute('insurance_plans_edit'))
                                                    ...
                                                    <a href="{{route('marine_plan.edit', encrypt($data->id))}}" class="btn p-0 m-0" title="Edit">
    ...
    <div class="modal fade " id="DeleteModal" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                ...
                <form action="{{route('marine_plan.delete')}}" method="post">
...
@section('script')
    <script src="{{asset('js/marine_plan.js?v=1')}}"></script>
@endsection
