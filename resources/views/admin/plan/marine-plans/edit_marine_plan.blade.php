                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                ...
                                <select name="type_of_cover_id" class="form-select rounded-0 flex-grow-1 border-0 shadow1" style="height: 2.5rem;" required>
                                    @foreach($type_of_covers as $single)
                                    <option
                                        value="{{$single->id}}" {{(old('type_of_cover_id') && old('type_of_cover_id') == $single->id) ? 'selected' : (($plan->type_of_cover_id == $single->id) ? 'selected' : '') }}>{{$single->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                ...
                                <select name="restricted_category_ids[]" class="form-select rounded-0 flex-grow-1 border-0 shadow1 select2" id="category_allowed" style="height: 3.5rem;" multiple>
                                    ...
                                    <option value="{{$single->id}}"
                                        {{ in_array($single->id, old('restricted_category_ids', !empty($plan->category_allowed) ? json_decode($plan->category_allowed) : [])) ? 'selected' : '' }}>
                                        {{$single->name}}
                                    </option>
                                    @endforeach
                                </select>
                                ...
                                <div class="category_{{$single->id}} all_sub_categories" style="display: none">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <input class="form-check-input" type="checkbox"
                                            ...
                                            @if(in_array($value->id,explode(',',$plan->sub_category_allowed)))
                                        checked
                                        @endif
                                        value="{{ $value->id }}">
                                    </div>
                        ...
                        <table class="table-bordered" style="width: 100%;">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="net_premium" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" id="net_premium" class="calc_gross_premium" style="border: none;" value="{{old('net_premium',($plan->net_premium ?? ''))}}" readonly required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                    ...
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="gross_premium" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" id="gross_premium" style="border: none;" value="{{old('gross_premium',($plan->gross_premium ?? ''))}}" readonly required>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
                        ...
                        <table class="table-bordered" style="width: 100%;">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" id="net_premium1" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" style="border: none;" value="{{old('net_premium',($plan->net_premium ?? ''))}}" readonly>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                    ...
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="commission_amount" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" id="commission_amount" style="border: none;" value="{{old('commission_amount',($plan->commission_amount ?? ''))}}" required readonly>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
...
<script src="{{asset('js/marine_plan.js?v=2.1')}}"></script>
@endsection
