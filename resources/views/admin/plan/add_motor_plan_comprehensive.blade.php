                ...
                <table class="table-bordered" style="width: 100%;">
                    ...
                    <tbody>
                        @for($i=0;$i<=10;$i++)
                            ...
                            <td>
                                <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                    <input type="text" name="fourth_year_increase[{{$i}}]" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" style="border: none;" required placeholder="{{__('messages.plans.example').' '.($i*2.5)}}"
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                    <input
                                        type="text"
                                        name="additional_benefits[0][benefit_limit]"
                                        style="border: none;"
                                        required>
                                </div>
                            </td>
                ...
                <table class="dynamic-table comprehensive" style="width: 100%;">
                    ...
                    <tbody>
                        <tr>
                            <td width="20%">
                                <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                    <select name="comprehensive_schedule[0][vehicle_brand_id][]"
                                        class="form-select rounded-0 flex-grow-1 border-0 shadow1 select2 select2-custom"
                                        style="height: 3.5rem;" multiple required>
                                        @foreach($vehicle_brands as $single)
                                        <option value="{{$single->id}}" {{ in_array($single->id, old('vehicle_brand_id', [])) ? 'selected' : '' }}>
                                            {{$single->name}}
                                        </option>
                                        @endforeach
                                    </select>
                            ...
                            <td width="20%">
                                <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                    <select name="comprehensive_schedule[0][vehicle_category_id][]"
                                        ...
                                        style="height: 3.5rem;" multiple required>
                                        @foreach($vehicle_categories as $single)
                                        <option value="{{$single->id}}" {{ in_array($single->id, old('vehicle_category_id', [])) ? 'selected' : '' }}>
                                            {{$single->name}}
                                        </option>
                                        @endforeach
                                    </select>
                            ...
                            <td>
                                <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                    <input type="text" name="comprehensive_schedule[0][premium]" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" style="border: none;" required>
                                </div>
                            </td>
                            <td width="5%">
                                <button class="btn p-0 m-0 deletebtn" title="Delete"><img src="{{asset('img/icon-delete.png')}}" alt=""></button>
                ...
                <table class="table-bordered" style="width: 100%;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                    <input type="text" name="cbj" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" style="border: none;" class="calc_gross_premium positive_number_only_2_decimal" id="cbj_sales_tax" required>
                                </div>
                            </td>
                            <td>
                                <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
