        ...
        <div class="container-fluid">
            <div class="header d-flex justify-content-between p-3 py-2 align-items-center">
                <div class="text-white group-title fw-bold">
                    {{__('messages.plans.edit_office_plan')}}
                </div>
            </div>
            <form action="{{route('office_plan.save')}}" id="add_motor_plan" method="post" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                    ...
                                    <select name="restricted_office_age_ids[]" class="form-select rounded-0 flex-grow-1 border-0 shadow1 select2" style="height: 3.5rem;" multiple>
                                        @foreach($ages as $single)
                                        <option value="{{$single->id}}"
                                            {{ in_array($single->id, old('restricted_office_age_ids', !empty($plan->restricted_office_age_ids) ? json_decode($plan->restricted_office_age_ids) : [])) ? 'selected' : '' }}>
                                            {{$single->age}} {{$single->type}}
                                        </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row">
                                <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                    ...
                                    <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                        <input type="text" name="limit" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" style="border: none;" required value="{{ old('limit') ?: (isset($plan->limit) ? number_format($plan->limit, 2) : '') }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <table class="table-bordered" style="width: 100%;">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                <input type="text" id="calc_limit" style="border: none;" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" value="{{ old('limit') ?: (isset($plan->limit) ? number_format($plan->limit, 2) : '') }}" readonly>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                <input type="text" name="net_premium" id="net_premium" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" class="calc_gross_premium positive_number_only_2_decimal" style="border: none;" value="{{old('net_premium', ($plan->net_premium ?? ''))}}" readonly required>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                        ...
                                        <td>
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                <input type="text" name="salextaxcbj" style="border: none;" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" value="{{old('sales_tax_cbj', ($plan->sales_tax_cbj ?? ''))}}" class="calc_gross_premium positive_number_only_2_decimal" id="cbj_sales_tax" required>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
...
<script src="{{asset('js/office_plan.js?v=1.1')}}"></script>
@endsection
