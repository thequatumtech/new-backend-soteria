    ...
    <div class="container-fluid">
        <div class="header d-flex justify-content-between p-3 py-2 align-items-center">
            <div class="text-white group-title fw-bold">
                {{__('messages.plans.add_office_plan')}}
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                ...
                                <select name="restricted_country_ids[]"
                                    ...
                                    <option value="{{ $single->id }}"
                                        {{ in_array($single->id, old('restricted_country_ids', [])) ? 'selected' : '' }}>
                                        {{ $single->name }}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                ...
                                <select name="restricted_city_ids[]"
                                    ...
                                    <option value="{{ $single->id }}"
                                        {{ in_array($single->id, old('restricted_city_ids', [])) ? 'selected' : '' }}>
                                        {{ $single->name }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                ...
                                <select name="restricted_district_ids[]"
                                    ...
                                    <option value="{{ $single->id }}"
                                        {{ in_array($single->id, old('restricted_district_ids', [])) ? 'selected' : '' }}>
                                        {{ $single->name }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <table class="table-bordered" style="width: 100%;">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="net_premium" id="net_premium" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" class="calc_gross_premium positive_number_only_2_decimal" style="border: none;" readonly required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                    ...
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="cbj" style="border: none;" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" class="calc_gross_premium positive_number_only_2_decimal" id="cbj" required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="salextaxcbj" style="border: none;" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" class="calc_gross_premium positive_number_only_2_decimal" id="cbj_sales_tax" required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="gross_premium" id="gross_premium" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" style="border: none;" readonly required>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
                        ...
                        <table class="table-bordered" style="width: 100%;">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="commission_percentage" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" id="commission_percentage" style="border: none;" class="positive_number_only_2_decimal" required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="commission_amount" id="commission_amount" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" style="border: none;" required readonly>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
