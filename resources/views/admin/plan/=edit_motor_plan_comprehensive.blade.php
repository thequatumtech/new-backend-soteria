...
@section('style')
    <style>
        ...
        table.comprehensive th, table.comprehensive tr, table.comprehensive td {
        ...
        <div class="container-fluid">
            <div class="header d-flex justify-content-between p-3 py-2 align-items-center">
                <div class="text-white group-title fw-bold">
                    {{ __('messages.plans.edit_comprehensive_plan') }}
                </div>
            </div>
            <form action="{{ route('motor_plan.save') }}" id="add_motor_plan" method="post" enctype="multipart/form-data">
                ...
                <input type="hidden" id="motor_plan_id" name="motor_plan_id" value="1">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                    ...
                                    <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                        <input type="text" style="border: none;" disabled
                                            value="{{ $plan->insurance_company->company_name }}">
                                    </div>
                                </div>
                                <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                    ...
                                    <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                        <input type="text" style="border: none;" disabled
                                            value="{{ $plan->line_of_business->name }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                    ...
                                    <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                        <input type="text" name="plan_name" style="border: none;" required
                                ...
                                <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                    ...
                                    <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                        <input type="date" name="start_date" id="start_date"
                                            min="{{ \Carbon\Carbon::parse($plan->start_date)->format('Y-m-d') }}"
                                ...
                                <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                    ...
                                    <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                        <input type="date" name="end_date" id="end_date"
                                            min="{{ \Carbon\Carbon::parse($plan->start_date)->addYears(1)->format('Y-m-d') }}"
                                            style="border: none; font-weight: 330;" required readonly
                            ...
                            <div class="row pt-4 pb-5 g-0 gap-4">
                                <div class="col-12 col-lg">
                                    ...
                                    @if (isset($plan) && $plan->insurance_policy_pdf)
                                        <a id="v_insurance_policy_pdf"
                                            href="{{ asset('uploads/insurance_plans') . '/' . $plan->id . '/' . $plan->insurance_policy_pdf }}"
                                            target="_blank">View</a>
                                    @endif
                                    <div class="card border-0 file-upload h-100 pt-2" style="cursor: pointer;">
                                        <div
                                            class="py-5 shadow1 d-flex flex-column justify-content-center align-items-center gap-3">
                                            <div>
                                                <img src="{{ asset('img/icon-upload.png') }}">
                                            </div>
                                            <input type="file" name="insurance_policy_pdf" id="insurance_policy_pdf"
                                            ...
                                            <div class="file-margin">
                                                ...
                                                <label id="insurance_policy_pdf-error" class="error"
                            ...
                            <div class="row">
                                <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                    ...
                                    <select name="restricted_country_ids[]"
                                        ...
                                        @foreach ($countries as $single)
                                            <option value="{{ $single->id }}"
                                                {{ in_array($single->id, old('restricted_country_ids', json_decode($plan->restricted_country_ids))) ? 'selected' : '' }}>
                                                {{ $single->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                    ...
                                    {{-- <select name="restricted_city_ids[]"
                                        ...
                                        @foreach ($cities as $single)
                                            <option value="{{ $single->id }}"
                                                {{ in_array($single->id, old('restricted_city_ids', json_decode($plan->restricted_city_ids))) ? 'selected' : '' }}>
                                                {{ $single->name }}</option>
                                        @endforeach
                                    </select> --}}
                            ...
                            <div class="row">
                                <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                    ...
                                    {{-- <select name="restricted_district_ids[]"
                                        ...
                                        @foreach ($districts as $single)
                                            <option value="{{ $single->id }}"
                                                {{ in_array($single->id, old('restricted_district_ids', json_decode($plan->restricted_district_ids))) ? 'selected' : '' }}>
                                                {{ $single->name }}</option>
                                        @endforeach
                                    </select> --}}
                                ...
                                <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                    ...
                                    <select name="restricted_age_ids[]"
                                        class="form-select rounded-0 flex-grow-1 border-0 shadow1 select2"
                                        style="height: 3.5rem;" multiple>
                                        @foreach ($ages as $single)
                                            <option value="{{ $single->id }}"
                                                {{ in_array($single->id, old('restricted_age_ids', json_decode($plan->restricted_age_ids))) ? 'selected' : '' }}>
                                                {{ $single->age }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                    ...
                                    <select name="restricted_vehicle_type_ids[]"
                                        ...
                                        @foreach ($vehicle_types as $single)
                                            <option value="{{ $single->id }}"
                                                {{ in_array($single->id, old('restricted_vehicle_type_ids', json_decode($plan->restricted_vehicle_type_ids))) ? 'selected' : '' }}>
                                                {{ $single->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                    ...
                                    <select name="restricted_vehicle_brand_ids[]"
                                        ...
                                        @foreach ($vehicle_brands as $single)
                                            <option value="{{ $single->id }}"
                                                {{ in_array($single->id, old('restricted_vehicle_brand_ids', json_decode($plan->restricted_vehicle_brand_ids))) ? 'selected' : '' }}>
                                                {{ $single->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                    ...
                                    <select name="restricted_vehicle_category_ids[]"
                                        ...
                                        @foreach ($vehicle_categories as $single)
                                            <option value="{{ $single->id }}"
                                                {{ in_array($single->id, old('restricted_vehicle_category_ids', json_decode($plan->restricted_vehicle_category_ids))) ? 'selected' : '' }}>
                                                {{ $single->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                    ...
                                    <select name="restricted_engine_type_ids[]"
                                        ...
                                        @foreach ($engine_types as $single)
                                            <option value="{{ $single->id }}"
                                                {{ in_array($single->id, old('restricted_engine_type_ids', json_decode($plan->restricted_engine_type_ids))) ? 'selected' : '' }}>
                                                {{ $single->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                    ...
                                    <select name="claim_deductible_ids[]"
                                        ...
                                        @foreach ($claim_deductibles as $single)
                                            <option value="{{ $single->id }}"
                                                {{ in_array($single->id, old('claim_deductible_ids', json_decode($plan->claim_deductible_ids))) ? 'selected' : '' }}>
                                                {{ $single->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                    ...
                                    @for ($i = 0; $i <= 16; $i++)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                    <input type="text"
                                                        name="increase_in_net_premium[{{ $i }}]"
                                                        style="border: none;" required
                                                        placeholder="{{ __('messages.plans.example') . ' ' . $i * 2.5 }}"
                                                        @php
                                                        $matchingCondition = $plan->plan_conditions->firstWhere('no_of_points', $i);
                                                        $increaseInNetPremium = $matchingCondition ? $matchingCondition->increase_in_net_premium : 0; @endphp
                            ...
                            <table class="table-bordered" style="width: 100%;">
                                ...
                                <tbody>
                                    @for ($i = 0; $i <= 10; $i++)
                                        @php
                                            $matchingCondition = $plan->net_premium_increase_percentages->firstWhere(
                                                'no_of_accidents',
                                                $i,
                                            );
                                            $current_year_increase = $matchingCondition
                                                ? $matchingCondition->current_year_increase
                                                : 0;
                                            $first_year_increase = $matchingCondition
                                                ? $matchingCondition->first_year_increase
                                                : 0;
                                            $second_year_increase = $matchingCondition
                                                ? $matchingCondition->second_year_increase
                                                : 0;
                                            $third_year_increase = $matchingCondition
                                                ? $matchingCondition->third_year_increase
                                                : 0;
                                            $fourth_year_increase = $matchingCondition
                                                ? $matchingCondition->fourth_year_increase
                                                : 0;
                                            $fifth_year_increase = $matchingCondition
                                                ? $matchingCondition->fifth_year_increase
                                                : 0;
                                        @endphp
                                        <tr>
                                            <td>{{ $i }}</td>
                                            ...
                                            <td>
                                                <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                    <input type="text" name="first_year_increase[{{ $i }}]"
                                                        style="border: none;" required
                                                        placeholder="{{ __('messages.plans.example') . ' ' . $i * 2.5 }}"
                                            ...
                                            <td>
                                                <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                    <input type="text" name="third_year_increase[{{ $i }}]"
                                                        style="border: none;" required
                                                        placeholder="{{ __('messages.plans.example') . ' ' . $i * 2.5 }}"
                                            ...
                                            <td>
                                                <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                    <input type="text" name="fifth_year_increase[{{ $i }}]"
                                                        style="border: none;" required
                                                        placeholder="{{ __('messages.plans.example') . ' ' . $i * 2.5 }}"
                                ...
                                <tbody>
                                            ...
                                            <tr data-id="{{ $index }}">
                                                ...
                                                <td width="5%">
                                                    <button class="btn p-0 m-0 deletebtn" title="Delete"><img
                                                            src="{{ asset('img/icon-delete.png') }}"
                                                            alt=""></button>
                                                </td>
                                                @if ($loop->first)
                                                    <td rowspan="{{ count(old('policy_covers', [])) }}"
                                                        class="add-more-cell">
                                                        <button class="btn add_more_btn" title="Add More">Add
                                                            More</button>
                                                    </td>
                                                @endif
                                            </tr>
                                            ...
                                            <tr data-id="{{ $index }}">
                                                <td width="50%">
                                                    <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                        <input type="text"
                                                            name="policy_covers[{{ $index }}][cover_name]"
                                                            value="{{ $single->cover_name }}" style="border: none;"
                                                            required>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                        ...
                                                        <input type="text"
                                                            name="policy_covers[{{ $index }}][cover_limit]"
                                                            value="{{ number_format($single->cover_limit) }}"
                                                            style="border: none;" required>
                                                    </div>
                                                </td>
                                                <td>
                                                ...
                                                @if ($loop->first)
                                                    <td rowspan="{{ $plan->policy_covers->count() }}"
                                                        class="add-more-cell">
                                                        <button class="btn add_more_btn" title="Add More">Add
                                                            More</button>
                                                    </td>
                                    ...
                                    @elseif(count(old('policy_covers', [])) == 0)
                                        <tr data-id="0">
                                            <td width="50%">
                                                <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                    <input type="text" name="policy_covers[0][cover_name]"
                                                        style="border: none;" required>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                    <input type="text" name="policy_covers[0][cover_limit]"
                                                        style="border: none;" required>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                    <input type="text" name="policy_covers[0][cover_deductible]"
                                                        style="border: none;" required>
                                                </div>
                                            </td>
                                            <td width="5%">
                                ...
                                <tbody>
                                        ...
                                        @foreach (old('additional_benefits') as $index => $policyCover)
                                            <tr data-id="{{ $index }}">
                                                <td width="50%">
                                                    <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                        <input type="text"
                                                            name="additional_benefits[{{ $index }}][benefit_name]"
                                                            value="{{ old('additional_benefits.' . $index . '.benefit_name') }}"
                                                            style="border: none;" required>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                        <input type="text"
                                                            ...
                                                            value="{{ old('additional_benefits.' . $index . '.benefit_limit') }}"
                                                            style="border: none;" required>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                        <input type="text"
                                                            name="additional_benefits[{{ $index }}][benefit_deductible]"
                                                            value="{{ old('additional_benefits.' . $index . '.benefit_deductible') }}"
                                                            style="border: none;" required>
                                                    </div>
                                                </td>
                                                <td width="5%">
                                                ...
                                                @if ($loop->first)
                                                    <td rowspan="{{ count(old('additional_benefits', [])) }}"
                                                        class="add-more-cell">
                                                        <button class="btn add_more_btn" title="Add More">Add
                                                            More</button>
                                                    </td>
                                            ...
                                            <tr>
                                                <td width="50%">
                                                    <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                        <input type="text"
                                                            name="additional_benefits[{{ $index }}][benefit_name]"
                                                            value="{{ $single->benefit_name }}" style="border: none;"
                                                            required>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                        <input type="text"
                                                            name="additional_benefits[{{ $index }}][benefit_limit]"
                                                            value="{{ $single->benefit_limit }}" style="border: none;"
                                                            required>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                        <input type="text"
                                                            name="additional_benefits[{{ $index }}][benefit_deductible]"
                                                            value="{{ $single->benefit_deductible }}"
                                                            style="border: none;" required>
                                                    </div>
                                                </td>
                                                <td width="5%">
                                                ...
                                                <td rowspan="{{ $plan->additional_benefits->count() }}"
                                                    class="add-more-cell">
                                                    <button class="btn add_more_btn" title="Add More">Add More</button>
                                                </td>
                                            </tr>
                                    ...
                                    @elseif(count(old('additional_benefits', [])) == 0)
                                        <tr>
                                            <td width="50%">
                                                <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                    <input type="text" name="additional_benefits[0][benefit_name]"
                                                        style="border: none;" required>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                    <input type="text" name="additional_benefits[0][benefit_limit]"
                                                        style="border: none;" required>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                    <input type="text"
                                                        name="additional_benefits[0][benefit_deductible]"
                                                        style="border: none;" required>
                                                </div>
                                            </td>
                                            <td width="5%">
                            ...
                            <h3 class="pt-5">{{ __('messages.plans.comprehensive_schedule') }}</h3>
                            <table class="dynamic-table comprehensive" style="width: 100%;">
                                <thead>
                                    <tr>
                                        <th>{{ __('messages.plans.vehicle_brand') }}</th>
                                        <th>{{ __('messages.plans.vehicle_category') }}</th>
                                        <th>{{ __('messages.plans.insured_value') }}</th>
                                ...
                                <tbody>
                                    {{-- <tr>
                                        <td width="20%">
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                <select name="comprehensive_schedule[0][vehicle_brand_id]" class="form-select rounded-0 flex-grow-1 border-0 shadow1 select2 select2-custom" style="height: 3.5rem;" required>
                                                    <option></option>
                                                    @foreach ($vehicle_brands as $single)
                                                        <option value="{{$single->id}}" {{in_array($single->id,old('vehicle_brand_id',[]))}}>{{$single->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </td>
                                        <td width="20%">
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                <select name="comprehensive_schedule[0][vehicle_category_id]"
                                                        class="form-select rounded-0 flex-grow-1 border-0 shadow1 select2 select2-custom"
                                                        style="height: 3.5rem;" required>
                                                    <option></option>
                                                    @foreach ($vehicle_categories as $single)
                                                        <option value="{{$single->id}}" {{in_array($single->id,old('vehicle_category_id',[]))}}>{{$single->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                <input type="text" name="comprehensive_schedule[0][insured_value]" style="border: none;" required>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                <input type="text" name="comprehensive_schedule[0][premium]" style="border: none;" required>
                                            </div>
                                        </td>
                                        <td width="5%">
                                    ...
                                    {{-- new start --}}
                                 @php
                                    $comprehensiveSchedules = old('comprehensive_schedule', $motor_comprehensive_plans);

                                    // Ensure at least one empty row exists
                                    if (empty($comprehensiveSchedules) || count($comprehensiveSchedules) == 0) {
                                        $comprehensiveSchedules = [['vehicle_brand_id' => '', 'vehicle_category_id' => '', 'insured_value' => '', 'premium' => '']];
                                    }
                                @endphp

                                    @foreach ($comprehensiveSchedules as $index => $schedule)                                    
                                    <tr>
                                        <td width="20%">
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                               {{-- @php dd($index); @endphp --}}
                                                <input type="hidden" name="comprehensive_schedule[{{ $index }}][id]" value="{{ $schedule->id }}">
                                                {{-- <input type="hidden" name="comprehensive_schedule[{{ $index }}][id]" value="{{ $schedule['id'] ?? ($schedule->id ?? '') }}"> --}}
                                                <select name="comprehensive_schedule[{{ $index }}][vehicle_brand_id]"
                                                        class="form-select rounded-0 flex-grow-1 border-0 shadow1 select2 select2-custom"
                                                        style="height: 3.5rem;" required>
                                                    <option value="">-- Select --</option>
                                                    @foreach ($vehicle_brands as $single)
                                                        <option value="{{ $single->id }}"
                                                            {{ (isset($schedule['vehicle_brand_id']) && $schedule['vehicle_brand_id'] == $single->id) || (isset($schedule->vehicle_brand_id) && $schedule->vehicle_brand_id == $single->id) ? 'selected' : '' }}>
                                                            {{ $single->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <td width="20%">
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                <select name="comprehensive_schedule[{{ $index }}][vehicle_category_id]"
                                                        class="form-select rounded-0 flex-grow-1 border-0 shadow1 select2 select2-custom"
                                                        style="height: 3.5rem;" required>
                                                    <option value="">-- Select --</option>
                                                    @foreach ($vehicle_categories as $single)
                                                        <option value="{{ $single->id }}"
                                                            {{ (isset($schedule['vehicle_category_id']) && $schedule['vehicle_category_id'] == $single->id) || (isset($schedule->vehicle_category_id) && $schedule->vehicle_category_id == $single->id) ? 'selected' : '' }}>
                                                            {{ $single->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <td>
                                            {{-- <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                <input type="text" name="comprehensive_schedule[{{ $index }}][insured_value]"
                                                    style="border: none;" required
                                                    value="{{ $schedule['insured_value'] ?? ($schedule->insured_value ?? '') }}">
                                            </div> --}}
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <input type="text" name="comprehensive_schedule[0][from]" class="border"  value="{{ $schedule['from'] ?? ($schedule->from ?? '') }}" required> 
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <label for="to">To</label>
                                                <div class="shadow1 p-2 mb-3" style="padding-bottom: 2.5rem;">
                                                <input type="text" name="comprehensive_schedule[0][to]" class="border"  value="{{ $schedule['to'] ?? ($schedule->to ?? '') }}" style="border: none;" required> 
                                                </div>
                                            </div>
                                        </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                <input type="text" name="comprehensive_schedule[{{ $index }}][premium]"
                                                    style="border: none;" required
                                                    value="{{ $schedule['premium'] ?? ($schedule->premium ?? '') }}">
                                            </div>
                                        </td>
                                        ...
                                        @if ($loop->first)
                                            <td rowspan="{{ count($comprehensiveSchedules) }}" class="add-more-cell">
                                                <button class="btn add_more_btn" title="Add More">Add More</button>
                                            </td>
                                        @endif
                                    </tr>
                            ...
                            {{-- <table class="table-bordered" style="width: 100%;">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                <input type="text" name="fees" style="border: none;"
                                                    value="{{ old('fees', $plan->fees->fees) }}" required>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                <input type="text" name="stamps" style="border: none;"
                                                    value="{{ old('stamps', $plan->fees->stamps) }}" required>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                <input type="text" name="sales_tax" style="border: none;"
                                                    value="{{ old('sales_tax', $plan->fees->sales_tax) }}" required>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" id="calc_plan_name" style="border: none;" value="{{old('plan_name',($plan->fees->plan_name ?? ''))}}" readonly>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" id="calc_limit" style="border: none;" value="{{old('limit',($plan->fees->limit ?? ''))}}" readonly>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="net_premium" id="net_premium" class="calc_gross_premium positive_number_only_2_decimal" style="border: none;" value="{{old('net_premium',($plan->fees->net_premium ?? ''))}}" readonly required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="fees" id="fees" class="calc_gross_premium positive_number_only_2_decimal" style="border: none;" value="{{old('fees',($plan->fees->fees ?? ''))}}" required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="stamps" id="stamps" class="calc_gross_premium positive_number_only_2_decimal" style="border: none;" value="{{old('stamps',($plan->fees->stamps ?? ''))}}" required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                            ...
                            <table class="table-bordered" style="width: 100%;">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                <input type="text" name="net_premium" style="border: none;"
                                                    value="{{ old('fees', $plan->fees->net_premium) }}" required>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                <input type="text" name="commission_percentage" style="border: none;"
                                                    value="{{ old('fees', $plan->fees->commission_percentage) }}"
                                                    required>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                <input type="text" name="commission_amount" style="border: none;"
                                                    value="{{ old('fees', $plan->fees->commission_amount) }}" required>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
                            ...
                            <div class="row pt-5">
                                ...
                                <div class="col-12 col-lg-3">
                                    <div class="pt-4 " style="border: none;">
                                        <button type="submit"
                                            class="btn rounded-1 w-100 text-white opacity-50 p-2 submit-btn"
                                            style="background-color: #EF7C00;">{{ isset($plan) ? __('messages.clients.save') : __('messages.clients.add') }}
                                        </button>
                                    </div>
                                </div>
                            </div>
                ...
                function fetchCBJ(companyId) {
                    if (companyId) {
                        $.ajax({
                            url: '{{ route("get.cbj") }}',
                            type: 'GET',
                            data: { insurance_company_id: companyId },
                            success: function (response) {
