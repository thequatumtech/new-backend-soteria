    ...
    <div class="container-fluid">
        <div class="header d-flex justify-content-between p-3 py-2 align-items-center">
            <div class="text-white group-title fw-bold">
                {{__('messages.plans.edit_pet_plan')}}
            </div>
        </div>
        <form action="{{route('pet_plan.save')}}" id="add_motor_plan" method="post" enctype="multipart/form-data">
            @csrf
...
<script src="{{asset('js/pet_plan.js?v=1.1')}}"></script>
@endsection