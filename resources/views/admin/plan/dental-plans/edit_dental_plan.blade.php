    ...
    <div class="container-fluid">
        <div class="header d-flex justify-content-between p-3 py-2 align-items-center">
            <div class="text-white group-title fw-bold">
                {{__('messages.plans.edit_dental_plan')}}
            </div>
        </div>
        <form action="{{route('dental_plan.save')}}" id="add_motor_plan" method="post" enctype="multipart/form-data">
            @csrf
                        ...
                        <table class="table-bordered" style="width: 100%;">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="net_premium" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" id="net_premium" class="calc_gross_premium positive_number_only_2_decimal" style="border: none;" value="{{old('net_premium',($plan->net_premium ?? ''))}}" required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
...
<script src="{{asset('js/dental_plan.js?v=1.1')}}"></script>
<script>
    $(document).ready(function() {
            ...
            if (companyId) {
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#net_premium').val('').trigger('change');
                    },
                    error: function() {
