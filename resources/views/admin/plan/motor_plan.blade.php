            ...
            <table id="example" class="table table-striped " style="width:100%">
                <thead>
                    <tr>
                        ...
                        <th>{{__('messages.plans.motor_plan_name')}}</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <!-- <td>
                            @if($data->commissionSchedules->isNotEmpty())
                            @foreach($data->commissionSchedules as $range)
                            {{ $range->from }} - {{ $range->to }}<br>
                            @endforeach
                            @else
                            -
                            @endif
                        ...
                        <td>
                            <div class="d-flex gap-3 justify-content-evenly align-items-center px-2">
                                ...
                                --}}
                                <a href="{{route('motor_plan.edit',$data->id)}}" class="btn p-0 m-0" title="Edit">
...
<div class="modal fade " id="DeleteModal" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            ...
            <form action="{{route('motor_plan.delete')}}" id="add" method="post">
        ...
        <div class="modal-content">
            ...
            <div class="row view-modal-content">
                ...
                <div class="has-company">
                    ...
                    <p><strong>{{__('messages.clients.practice_certificate')}} : </strong>
                        <a href="javascript:void(0);" target="_blank" id="vv_practice_certificate">View</a>
                    </p>
                </div>
            </div>
        </div>
