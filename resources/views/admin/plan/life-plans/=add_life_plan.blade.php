...
{{--                                <th>{{__('messages.plans.commission_amount')}}</th>--}}
                            ...
                            <tbody>
                            <tr>
                                <input type="hidden" id="net_premium" name="net_premium" style="border: none;" value="0">
{{--
                                <td>
                                    <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
...
--}}
                                <td>
                                    <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                        <input type="text" name="commission_percentage" id="commission_percentage" class="positive_number_only_2_decimal" style="border: none;" required>
                                    </div>
                                </td>
