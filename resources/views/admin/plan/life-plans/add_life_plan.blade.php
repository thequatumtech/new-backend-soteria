    ...
    <div class="container-fluid">
        <div class="header d-flex justify-content-between p-3 py-2 align-items-center">
            <div class="text-white group-title fw-bold">
                {{__('messages.plans.add_life_plan')}}
            </div>
        </div>
                ...
                <div class="row p-3" style="color: #92959A;">
                    <div class="container">
                            ...
                            <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                ...
                                <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                    <input type="number" id="policy_period" class="form-control number"
                                        name="policy_period" style="border: none;" required max="4745">
                                </div>
                            </div>
                        </div> --}}
                            ...
                            <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                ...
                                <select name="restricted_country_ids[]"
                                    ...
                                    <option value="{{ $country->id }}"
                                        {{ in_array($country->id, old('restricted_country_ids', [])) ? 'selected' : '' }}>
                                        {{ $country->name }}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                ...
                                <select name="restricted_city_ids[]"
                                    ...
                                    <option value="{{ $city->id }}"
                                        {{ in_array($city->id, old('restricted_city_ids', [])) ? 'selected' : '' }}>
                                        {{ $city->name }}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                ...
                                <select name="restricted_district_ids[]"
                                    ...
                                    <option value="{{ $district->id }}"
                                        {{ in_array($district->id, old('restricted_district_ids', [])) ? 'selected' : '' }}>
                                        {{ $district->name }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                ...
                                <select name="restricted_chronic_ids[]" class="form-select rounded-0 flex-grow-1 border-0 shadow1 select2" style="height: 3.5rem;" multiple>
                                    ...
                                    <option value="{{$single->id}}" {{in_array($single->id,old('restricted_chronic_ids',[]))}}>{{$single->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <table class="table-bordered" style="width: 100%;">
                            ...
                            <tbody>
                                @for($i=21;$i<=60;$i++)
                                    ...
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="pricing_schedule[{{$i}}][year_1]" style="border: none;" value=""
                                                required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="pricing_schedule[{{$i}}][year_2]" style="border: none;" value=""
                                                required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="pricing_schedule[{{$i}}][year_3]" style="border: none;" value=""
                                                required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="pricing_schedule[{{$i}}][year_4]" style="border: none;" value=""
                                                required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="pricing_schedule[{{$i}}][year_5]" style="border: none;" value=""
                                                required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="pricing_schedule[{{$i}}][year_6]" style="border: none;" value=""
                                                required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="pricing_schedule[{{$i}}][year_7]" style="border: none;" value=""
                                                required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="pricing_schedule[{{$i}}][year_8]" style="border: none;" value=""
                                                required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="pricing_schedule[{{$i}}][year_9]" style="border: none;" value=""
                                                required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="pricing_schedule[{{$i}}][year_10]" style="border: none;" value=""
                                                required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="pricing_schedule[{{$i}}][year_11]" style="border: none;" value=""
                                                required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="pricing_schedule[{{$i}}][year_12]" style="border: none;" value=""
                                                required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="pricing_schedule[{{$i}}][year_13]" style="border: none;" value=""
                                                required>
                                        </div>
                                    </td>
                                    </tr>
                        ...
                        <table class="table-bordered" style="width: 100%;">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="stamps" id="stamps" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" class="calc_gross_premium positive_number_only_2_decimal" style="border: none;" required>
                                        </div>
                                    </td>

                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="sales_tax" id="sales_tax" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" class="calc_gross_premium positive_number_only_2_decimal" style="border: none;" required>
                                        </div>
                                    </td>

                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="cbj" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" style="border: none;" class="calc_gross_premium positive_number_only_2_decimal" id="cbj" required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="salextaxcbj" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" style="border: none;" class="calc_gross_premium positive_number_only_2_decimal" id="cbj_sales_tax" required>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
                        ...
                        <table class="table-bordered" style="width: 100%;">
                            ...
                            <tbody>
                                <tr>
                                    <input type="hidden" id="net_premium" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" name="net_premium" style="border: none;" value="0">
                                    {{--
                                <td>
                                    <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                        <input type="text" id="net_premium" name="net_premium" style="border: none;" required>
                                    </div>
                                </td>
--}}
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="commission_percentage" id="commission_percentage" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" class="positive_number_only_2_decimal" style="border: none;" required>
                                        </div>
                                    </td>
                                    <input type="hidden" name="commission_amount" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" id="commission_amount" style="border: none;" required value="0">
                                    {{--
                                <td>
                                    <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
