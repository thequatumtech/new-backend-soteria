    ...
    <div class="container-fluid">
        <div class="header d-flex justify-content-between p-3 py-2 align-items-center">
            <div class="text-white group-title fw-bold">
                {{__('messages.plans.edit_life_plan')}}
            </div>
        </div>
        <form action="{{route('life_plan.save')}}" id="add_motor_plan" method="post" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="container">
                        ...
                        <table class="table-bordered dynamic-table" style="width: 100%;">
                            ...
                            <tbody>
                                ...
                                <tr data-id="{{$index}}">
                                    <td width="50%">
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="hidden" name="policy_covers[{{ $index }}][id]" value="{{ $single->id }}">
                                            <input type="text" name="policy_covers[{{ $index }}][cover_name]" value="{{ $single->cover_name }}" style="border: none;" required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="policy_covers[{{ $index }}][cover_limit]" value="{{ number_format((float) $single->cover_limit) }}" style="border: none;" required>
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                ...
                                <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                    <input type="text" name="limit" maxlength="10" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" style="border: none;" required value="{{old('limit')?:($plan->limit ?? '')}}">
                                </div>
                            </div>
                        </div>
                        ...
                        <table class="table-bordered" style="width: 100%;">
                            <thead>
                                <tr>
                                    <th colspan="14">{{__('messages.plans.pricing_schedule')}}</th>
                                </tr>
                                <tr>
                                    <th width="9%">{{__('messages.plans.age_period')}}</th>
                                    <th>{{__('messages.plans.yr_1')}}</th>
                                    <th>{{__('messages.plans.yr_2')}}</th>
                                    <th>{{__('messages.plans.yr_3')}}</th>
                                    <th>{{__('messages.plans.yr_4')}}</th>
                                    <th>{{__('messages.plans.yr_5')}}</th>
                                    <th>{{__('messages.plans.yr_6')}}</th>
                                    <th>{{__('messages.plans.yr_7')}}</th>
                                    <th>{{__('messages.plans.yr_8')}}</th>
                                    <th>{{__('messages.plans.yr_9')}}</th>
                                    <th>{{__('messages.plans.yr_10')}}</th>
                                    <th>{{__('messages.plans.yr_11')}}</th>
                                    <th>{{__('messages.plans.yr_12')}}</th>
                                    <th>{{__('messages.plans.yr_13')}}</th>
                                </tr>
                            </thead>
                            <tbody>
                                @for($i=21;$i<=60;$i++)
                                    ...
                                    $year_1 = $matchingCondition ? $matchingCondition->year_1 : 0;
                                    $year_2 = $matchingCondition ? $matchingCondition->year_2 : 0;
                                    $year_3 = $matchingCondition ? $matchingCondition->year_3 : 0;
                                    $year_4 = $matchingCondition ? $matchingCondition->year_4 : 0;
                                    $year_5 = $matchingCondition ? $matchingCondition->year_5 : 0;
                                    $year_6 = $matchingCondition ? $matchingCondition->year_6 : 0;
                                    $year_7 = $matchingCondition ? $matchingCondition->year_7 : 0;
                                    $year_8 = $matchingCondition ? $matchingCondition->year_8 : 0;
                                    $year_9 = $matchingCondition ? $matchingCondition->year_9 : 0;
                                    $year_10 = $matchingCondition ? $matchingCondition->year_10 : 0;
                                    $year_11 = $matchingCondition ? $matchingCondition->year_11 : 0;
                                    $year_12 = $matchingCondition ? $matchingCondition->year_12 : 0;
                                    $year_13 = $matchingCondition ? $matchingCondition->year_13 : 0;
                                    @endphp
                                    ...
                                    <tr data-id="0">
                                        ...
                                        <td>
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                <input type="text" name="pricing_schedule[{{$i}}][year_1]" style="border: none;" value="{{$year_1}}"
                                                    required>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                <input type="text" name="pricing_schedule[{{$i}}][year_2]" style="border: none;" value="{{$year_2}}"
                                                    required>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                <input type="text" name="pricing_schedule[{{$i}}][year_3]" style="border: none;" value="{{$year_3}}"
                                                    required>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                <input type="text" name="pricing_schedule[{{$i}}][year_4]" style="border: none;" value="{{$year_4}}"
                                                    required>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                <input type="text" name="pricing_schedule[{{$i}}][year_5]" style="border: none;" value="{{$year_5}}"
                                                    required>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                <input type="text" name="pricing_schedule[{{$i}}][year_6]" style="border: none;" value="{{$year_6}}"
                                                    required>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                <input type="text" name="pricing_schedule[{{$i}}][year_7]" style="border: none;" value="{{$year_7}}"
                                                    required>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                <input type="text" name="pricing_schedule[{{$i}}][year_8]" style="border: none;" value="{{$year_8}}"
                                                    required>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                <input type="text" name="pricing_schedule[{{$i}}][year_9]" style="border: none;" value="{{$year_9}}"
                                                    required>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                <input type="text" name="pricing_schedule[{{$i}}][year_10]" style="border: none;" value="{{$year_10}}"
                                                    required>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                <input type="text" name="pricing_schedule[{{$i}}][year_11]" style="border: none;" value="{{$year_11}}"
                                                    required>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                <input type="text" name="pricing_schedule[{{$i}}][year_12]" style="border: none;" value="{{$year_12}}"
                                                    required>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                                <input type="text" name="pricing_schedule[{{$i}}][year_13]" style="border: none;" value="{{$year_13}}"
                                                    required>
                                            </div>
                                        </td>
                                    </tr>
                        ...
                        <table class="table-bordered" style="width: 100%;">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="fees" id="fees" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" class="calc_gross_premium positive_number_only_2_decimal" style="border: none;" value="{{old('fees',($plan->fees ?? ''))}}" required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="stamps" id="stamps" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" class="calc_gross_premium positive_number_only_2_decimal" style="border: none;" value="{{old('stamps',($plan->stamps ?? ''))}}" required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="sales_tax" id="sales_tax" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" class="calc_gross_premium positive_number_only_2_decimal" style="border: none;" value="{{old('sales_tax',($plan->sales_tax ?? ''))}}" required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="cbj" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" style="border: none;" value="{{old('gross_premium',($plan->cbj ?? ''))}}" class="calc_gross_premium positive_number_only_2_decimal" id="cbj" required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="salextaxcbj" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" style="border: none;" value="{{old('gross_premium',($plan->sales_tax_cbj ?? ''))}}" class="calc_gross_premium positive_number_only_2_decimal" id="cbj_sales_tax" required>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
                        ...
                        <table class="table-bordered" style="width: 100%;">
                            ...
                            <tbody>
                                <tr>
                                    <input type="hidden" id="net_premium" name="net_premium" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" style="border: none;" value="{{old('net_premium',($plan->net_premium ?? 0))}}">
                                    <input type="hidden" name="commission_amount" id="commission_amount" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" style="border: none;" value="{{old('commission_amount',($plan->commission_amount ?? 0))}}" readonly>
                                    {{--
                                <td>
                                    <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                        <input type="text" id="net_premium" name="net_premium" style="border: none;" value="{{old('net_premium',($plan->net_premium ?? ''))}}" required>
                    </div>
                    </td>
                    --}}
                    <td>
                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                            <input type="text" name="commission_percentage" id="commission_percentage" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" class="positive_number_only_2_decimal" style="border: none;" value="{{old('commission_percentage',($plan->commission_percentage ?? ''))}}" required>
                        </div>
                    </td>
                    {{--
                                <td>
...
<script src="{{asset('js/life_plan.js?v=1')}}"></script>
@endsection