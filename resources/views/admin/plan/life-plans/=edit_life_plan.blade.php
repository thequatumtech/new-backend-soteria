...
{{--                                <th>{{__('messages.plans.commission_amount')}}</th>--}}
                            ...
                            <tbody>
                            <tr>
                                <input type="hidden" id="net_premium" name="net_premium" style="border: none;" value="{{old('net_premium',($plan->net_premium ?? 0))}}">
                                <input type="hidden" name="commission_amount" id="commission_amount" style="border: none;" value="{{old('commission_amount',($plan->commission_amount ?? 0))}}" readonly>
{{--
                                <td>
                                    <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
