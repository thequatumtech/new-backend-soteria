                ...
                <div class="row p-3" style="color: #92959A;">
                    <div class="container">
                        ...
                        <table class="table-bordered dynamic-table" style="width: 100%;">
                            ...
                            <tbody>
                                @if (old('compulsory_schedule_9_months'))
                                @foreach(old('compulsory_schedule_9_months') as $index => $item)
                                <tr data-id="{{ $index }}">
                                    <td width="40%">
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="compulsory_schedule_9_months[{{ $index }}][vehicle_type]" value="{{ old('compulsory_schedule_9_months.'.$index.'.vehicle_type') }}" style="border: none;" required>
                                        </div>
                                    </td>
                                    <td width="40%">
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="compulsory_schedule_9_months[{{ $index }}][premium]" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" value="{{ old('compulsory_schedule_9_months.'.$index.'.premium') }}" style="border: none;" required>
                                        </div>
                                    </td>
                                    <td width="5%">
                                        <button class="btn p-0 m-0 deletebtn" title="Delete"><img src="{{asset('img/icon-delete.png')}}" alt=""></button>
                                    ...
                                    @if ($loop->first)
                                    <td rowspan="{{count(old('compulsory_schedule_9_months', []))}}" class="add-more-cell">
                                        <button class="btn add_more_btn" title="Add More">Add More</button>
                                    </td>
                                    @endif
                                </tr>
                                @endforeach
                                @elseif(isset($compulsory_premiums_9) && $compulsory_premiums_9->count() > 0)
                                @foreach($compulsory_premiums_9 as $index => $item)
                                <tr data-id="{{ $index }}">
                                    <td width="40%">
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="compulsory_schedule_9_months[{{ $index }}][vehicle_type]" value="{{ $item->vehicle_type ?? '' }}" style="border: none;" required>
                                        </div>
                                    </td>
                                    <td width="40%">
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="compulsory_schedule_9_months[{{ $index }}][premium]" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" value="{{ $item->premium ?? '' }}" style="border: none;" required>
                                        </div>
                                    </td>
                                    <td width="5%">
                                        <button class="btn p-0 m-0 deletebtn" title="Delete"><img src="{{asset('img/icon-delete.png')}}" alt=""></button>
                                    ...
                                    @if ($loop->first)
                                    <td rowspan="{{ $compulsory_premiums_9->count() }}" class="add-more-cell">
                                        <button class="btn add_more_btn" title="Add More">Add More</button>
                                    </td>
                                    @endif
                                </tr>
                                ...
                                <tr data-id="0">
                                    <td width="40%">
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="compulsory_schedule_9_months[0][vehicle_type]" style="border: none;" required>
                                        </div>
                                    </td>
                                    <td width="40%">
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="compulsory_schedule_9_months[0][premium]" oninput="this.value = this.value.replace(/[^0-9.]/g, '').split('.').slice(0, 2).join('.');" style="border: none;" required>
                                        </div>
                                    </td>
                                    <td width="5%">
                                        <button class="btn p-0 m-0 deletebtn" title="Delete"><img src="{{asset('img/icon-delete.png')}}" alt=""></button>
