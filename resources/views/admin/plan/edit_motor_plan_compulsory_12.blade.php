                    ...
                    <div class="container">
                            ...
                            <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                ...
                                <select name="restricted_country_ids[]" id="restricted_country_ids" class="form-select rounded-0 flex-grow-1 border-0 shadow1 select2" style="height: 3.5rem;" multiple>
                                    ...
                                    <option value="{{$single->id}}"
                                          {{ in_array($single->id, $selected_country_ids) ? 'selected' : '' }}>
                                        {{$single->name}}
                                    </option>
                            ...
                            <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                               ...
                               <select name="restricted_city_ids[]" class="form-select rounded-0 flex-grow-1 border-0 shadow1 select2" style="height: 3.5rem;" multiple>
                                @foreach($cities as $single)
                                    <option value="{{$single->id}}"
                                       {{ in_array($single->id, $selected_city_ids) ? 'selected' : '' }}>
                                        {{$single->name}}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                ...
                                <select name="restricted_district_ids[]" id="restricted_district_ids" class="form-select rounded-0 flex-grow-1 border-0 shadow1 select2" style="height: 3.5rem;" multiple>
                                    @foreach($districts as $single)
                                    <option value="{{$single->id}}" 
                                    {{ in_array($single->id, $selected_district_ids) ? 'selected' : '' }}>
                                    {{$single->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                ...
                                <select name="restricted_vehicle_type_ids[]" class="form-select rounded-0 flex-grow-1 border-0 shadow1 select2" style="height: 3.5rem;" multiple>
                                    ...
                                    <option value="{{$single->id}}"
                                        {{ in_array($single->id, old('restricted_vehicle_type_ids', json_decode($plan->restricted_vehicle_type_ids, true) ?? [])) ? 'selected' : '' }}>
                                        {{$single->name}}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                ...
                                <select name="restricted_vehicle_brand_ids[]" class="form-select rounded-0 flex-grow-1 border-0 shadow1 select2" style="height: 3.5rem;" multiple>
                                    ...
                                    <option value="{{$single->id}}"
                                        {{ in_array($single->id, old('restricted_vehicle_brand_ids', json_decode($plan->restricted_vehicle_brand_ids, true) ?? [])) ? 'selected' : '' }}>
                                        {{$single->name}}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                ...
                                <select name="restricted_vehicle_category_ids[]" class="form-select rounded-0 flex-grow-1 border-0 shadow1 select2" style="height: 3.5rem;" multiple>
                                    ...
                                    <option value="{{$single->id}}"
                                        {{ in_array($single->id, old('restricted_vehicle_category_ids', json_decode($plan->restricted_vehicle_category_ids, true) ?? [])) ? 'selected' : '' }}>
                                        {{$single->name}}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                ...
                                <select name="restricted_engine_type_ids[]" class="form-select rounded-0 flex-grow-1 border-0 shadow1 select2" style="height: 3.5rem;" multiple>
                                    ...
                                    <option value="{{$single->id}}"
                                        {{ in_array($single->id, old('restricted_engine_type_ids', json_decode($plan->restricted_engine_type_ids, true) ?? [])) ? 'selected' : '' }}>
                                        {{$single->name}}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-6 pt-4 d-flex flex-column">
                                ...
                                <select name="claim_deductible_ids[]" class="form-select rounded-0 flex-grow-1 border-0 shadow1 select2" style="height: 3.5rem;" required multiple>
                                    ...
                                    <option value="{{$single->id}}"
                                        {{ in_array($single->id, old('claim_deductible_ids', json_decode($plan->claim_deductible_ids, true) ?? [])) ? 'selected' : '' }}>
                                        {{$single->name}}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <table class="table-bordered dynamic-table" style="width: 100%;">
                            ...
                            <tbody>
                                @php
                                $compulsory_12_months_premiums = \App\Models\InsurancePlanModels\MotorInsurancePlan12MonthsCompulsoryPremium::where('motor_insurance_plan_id', $plan->id)->get();
                                @endphp
                                @if($compulsory_12_months_premiums->count() > 0)
                                @foreach($compulsory_12_months_premiums as $index => $premium)
                                <tr>
                                    <td width="40%">
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="compulsory_schedule_12_months[{{$index}}][vehicle_type]" value="{{$premium->vehicle_type}}" style="border: none;" required>
                                        </div>
                                    </td>
                                    <td width="40%">
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="compulsory_schedule_12_months[{{$index}}][premium]" value="{{$premium->premium}}" style="border: none;" required>
                                        </div>
                                    </td>
                                    <td width="5%">
                                        <button class="btn p-0 m-0 deletebtn" title="Delete"><img src="{{asset('img/icon-delete.png')}}" alt=""></button>
                                    ...
                                    @if($loop->first)
                                    <td rowspan="{{$compulsory_12_months_premiums->count()}}" class="add-more-cell">
                                        <button class="btn add_more_btn" title="Add More">Add More</button>
                                    </td>
                                    @endif
                                </tr>
                                ...
                                <tr>
                                    <td width="40%">
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="compulsory_schedule_12_months[0][vehicle_type]" style="border: none;" required>
                                        </div>
                                    </td>
                                    <td width="40%">
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="compulsory_schedule_12_months[0][premium]" style="border: none;" required>
                                        </div>
                                    </td>
                                    <td width="5%">
                                        <button class="btn p-0 m-0 deletebtn" title="Delete"><img src="{{asset('img/icon-delete.png')}}" alt=""></button>
                        ...
                        <table class="table-bordered" style="width: 100%;">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="cbj" style="border: none;" value="{{old('cbj',($plan->fees->cbj ?? ''))}}" class="cover_premium positive_number_only_2_decimal" id="cbj" required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="shadow1 p-2" style="padding-bottom: 2.5rem;">
                                            <input type="text" name="salextaxcbj" style="border: none;" value="{{old('salextaxcbj',($plan->fees->sales_tax_cbj ?? ''))}}" class="cover_premium positive_number_only_2_decimal" id="sales_tax_cbj" required>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
