...
<main class="flex-grow-1 pt-5">
    <div class="container-fluid">
        <div class="header d-flex justify-content-between p-3 py-2 align-items-center">
            ...
            'pdfRoute' => route('reports.download', ['report' => 'pets_policies_report', 'format' => 'pdf']),
            'excelRoute' => route('reports.download', ['report' => 'pets_policies_report', 'format' => 'excel']),
            'filePrefix' => 'Pets_Policies_Report',
            ])
        </div>
        <!-- Form to be toggled -->
