...
<main class="flex-grow-1 pt-5">
    <div class="container-fluid">
        <div class="header d-flex justify-content-between p-3 py-2 align-items-center">
            <div class="text-white group-title fw-bold">{{__('messages.reports.renewed_by_admin')}} {{__('messages.reports.reports')}}</div>
            @include('admin.reports.partials.report-download-controls', [
            'pdfRoute' => route('reports.download', ['report' => 'renewed_by_admin_report', 'format' => 'pdf']),
            'excelRoute' => route('reports.download', ['report' => 'renewed_by_admin_report', 'format' => 'excel']),
            'filePrefix' => 'Renewed_By_Admin_Report',
            ])
        </div>
        <!-- Form to be toggled -->
            ...
            <table class="table table-striped " style="width:100%">
                <thead>
                    <tr>
                        ...
                        <th class="no-order no-search">{{__('messages.clients.agent')}}</th>
                        ...
                        <!-- <th class="no-order no-search">{{__('messages.reports.reason_of_renewal_by_admin')}}</th> -->
                    </tr>
                </thead>
                <tbody>
