...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('marine_plans', function (Blueprint $table) {
            $table->id();
...
//            $table->longText('allowed_category')->nullable();
//            $table->longText('allowed_subcategory')->nullable();
            $table->float('limit');
    ...
    {
        Schema::dropIfExists('marine_plans');
    }
};
