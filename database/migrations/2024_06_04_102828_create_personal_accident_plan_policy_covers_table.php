...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('personal_accident_plan_policy_covers', function (Blueprint $table) {
            $table->id();
            $table->bigInteger('personal_accident_plan_id');
    ...
    {
        Schema::dropIfExists('personal_accident_plan_policy_covers');
    }
};
