...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('critical_illness_plan_policy_covers', function (Blueprint $table) {
            $table->id();
            $table->bigInteger('critical_illness_plan_id');
    ...
    {
        Schema::dropIfExists('critical_illness_plan_policy_covers');
    }
};
