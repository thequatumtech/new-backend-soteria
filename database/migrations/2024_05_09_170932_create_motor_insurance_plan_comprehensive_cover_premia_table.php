...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('motor_insurance_plan_comprehensive_cover_premiums', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('motor_insurance_plan_comprehensive_cover_premiums');
    }
};
